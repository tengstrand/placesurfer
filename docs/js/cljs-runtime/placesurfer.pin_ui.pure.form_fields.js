...
var G__96090 = e.target.value;
return (set_pin_name_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_name_BANG_.cljs$core$IFn$_invoke$arity$1(G__96090) : set_pin_name_BANG_.call(null,G__96090));
...
var G__96091 = e.target.value;
return (set_pin_address_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_address_BANG_.cljs$core$IFn$_invoke$arity$1(G__96091) : set_pin_address_BANG_.call(null,G__96091));
})], null)], null)], null)], null)], null);
});
...
return cljs.core.chunk_cons(cljs.core.chunk(b__96095),placesurfer$pin_ui$pure$form_fields$icon_and_radii_row_$_iter__96092(cljs.core.chunk_rest(s__96093__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__96095),null);
}
} else {
var filename = cljs.core.first(s__96093__$2);
return cljs.core.cons(placesurfer.pin_ui.pure.form_fields.icon_dropdown_option(filename,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(filename,selected_icon),set_pin_icon_BANG_),placesurfer$pin_ui$pure$form_fields$icon_and_radii_row_$_iter__96092(cljs.core.rest(s__96093__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__96099),placesurfer$pin_ui$pure$form_fields$icon_and_radii_row_$_iter__96096(cljs.core.chunk_rest(s__96097__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__96099),null);
}
} else {
var filename = cljs.core.first(s__96097__$2);
return cljs.core.cons(placesurfer.pin_ui.pure.form_fields.stars_dropdown_option(filename,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(filename,selected_ranking),set_pin_stars_BANG_),placesurfer$pin_ui$pure$form_fields$icon_and_radii_row_$_iter__96096(cljs.core.rest(s__96097__$2)));
}
} else {
return null;
}
...
var G__96100 = e.target.value;
return (set_pin_radii_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_radii_BANG_.cljs$core$IFn$_invoke$arity$1(G__96100) : set_pin_radii_BANG_.call(null,G__96100));
})], null)], null)], null)], null)], null);
});
...
var G__96101 = e.target.value;
return (set_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__96101) : set_pin_longitude_BANG_.call(null,G__96101));
}),new cljs.core.Keyword(null,"blur","blur",-453500461),(function (e){
var G__96102 = e.target.value;
return (commit_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? commit_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__96102) : commit_pin_longitude_BANG_.call(null,G__96102));
...
var G__96103 = e.target.value;
return (set_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__96103) : set_pin_latitude_BANG_.call(null,G__96103));
}),new cljs.core.Keyword(null,"blur","blur",-453500461),(function (e){
var G__96104 = e.target.value;
return (commit_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? commit_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__96104) : commit_pin_latitude_BANG_.call(null,G__96104));
})], null)], null)], null)], null)], null);
});
...
var G__96105 = e.target.value;
return (set_pin_url_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_url_BANG_.cljs$core$IFn$_invoke$arity$1(G__96105) : set_pin_url_BANG_.call(null,G__96105));
...
var G__96106 = e.target.value;
return (set_pin_image_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_image_BANG_.cljs$core$IFn$_invoke$arity$1(G__96106) : set_pin_image_BANG_.call(null,G__96106));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.update-field-row","div.update-field-row",1544435964),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.update-label","label.update-label",1775033508),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"for","for",-1323786319),"pin-agent-url"], null),(t.cljs$core$IFn$_invoke$arity$1 ? t.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("pin","agent-url","pin/agent-url",-1203892790)) : t.call(null,new cljs.core.Keyword("pin","agent-url","pin/agent-url",-1203892790)))], null),placesurfer.pin_ui.pure.form_fields.field_link_control(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input#pin-agent-url.update-input","input#pin-agent-url.update-input",805383505),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),placesurfer.pin_ui.pure.forms.coerce_text(agent_url),new cljs.core.Keyword(null,"on","on",173873944),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"input","input",556931961),(function (e){
var G__96107 = e.target.value;
return (set_pin_agent_url_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_agent_url_BANG_.cljs$core$IFn$_invoke$arity$1(G__96107) : set_pin_agent_url_BANG_.call(null,G__96107));
})], null)], null)], null),((cljs.core.seq(agent_url))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.pin-field-link","a.pin-field-link",-257879090),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"href","href",-793805698),agent_url,new cljs.core.Keyword(null,"target","target",253001721),"_blank",new cljs.core.Keyword(null,"rel","rel",1378823488),"noopener noreferrer"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img.pin-field-link-icon","img.pin-field-link-icon",-1559218723),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),"/images/agent.png",new cljs.core.Keyword(null,"alt","alt",-3214426),""], null)], null)], null):null))], null);
});
placesurfer.pin_ui.pure.form_fields.description_row = (function placesurfer$pin_ui$pure$form_fields$description_row(props){
var map__96108 = props;
var map__96108__$1 = cljs.core.__destructure_map(map__96108);
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96108__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var description_edit_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96108__$1,new cljs.core.Keyword(null,"description-edit-mode","description-edit-mode",-1941940982));
var description_sync_token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96108__$1,new cljs.core.Keyword(null,"description-sync-token","description-sync-token",-1307199437));
var set_pin_description_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96108__$1,new cljs.core.Keyword(null,"set-pin-description!","set-pin-description!",-891657600));
var toggle_description_edit_mode_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96108__$1,new cljs.core.Keyword(null,"toggle-description-edit-mode!","toggle-description-edit-mode!",-361122656));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96108__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
var map__96110 = props;
var map__96110__$1 = cljs.core.__destructure_map(map__96110);
var show_pin_group_field_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"show-pin-group-field?","show-pin-group-field?",2032273049));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__96110__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
var commit_pin_longitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"commit-pin-longitude!","commit-pin-longitude!",-1228268614));
var pin_items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"pin-items","pin-items",-1214148100));
var pin_editor_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"pin-editor-mode","pin-editor-mode",-577269186));
var set_pin_url_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-url!","set-pin-url!",-248892450));
var set_pin_description_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-description!","set-pin-description!",-891657600));
var set_pin_radii_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-radii!","set-pin-radii!",1761601184));
var toggle_description_edit_mode_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"toggle-description-edit-mode!","toggle-description-edit-mode!",-361122656));
var set_pin_address_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-address!","set-pin-address!",943678529));
var set_pin_name_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-name!","set-pin-name!",-689410779));
var set_pin_group_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-group!","set-pin-group!",928267686));
var set_pin_icon_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-icon!","set-pin-icon!",1169299015));
var set_pin_latitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-latitude!","set-pin-latitude!",1547178985));
var pin_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"pin-form","pin-form",1370425130));
var description_edit_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"description-edit-mode","description-edit-mode",-1941940982));
var pin_selected_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"pin-selected-id","pin-selected-id",261877228));
var commit_pin_latitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"commit-pin-latitude!","commit-pin-latitude!",-2003886132));
var set_pin_agent_url_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-agent-url!","set-pin-agent-url!",1449358350));
var set_pin_longitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-longitude!","set-pin-longitude!",1371393039));
var pin_group_options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"pin-group-options","pin-group-options",550206512));
var set_pin_stars_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-stars!","set-pin-stars!",1351285040));
var description_sync_token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"description-sync-token","description-sync-token",-1307199437));
var pin_group_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"pin-group-id","pin-group-id",-380160105));
var set_pin_image_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96110__$1,new cljs.core.Keyword(null,"set-pin-image!","set-pin-image!",1564686327));
var map__96111 = pin_form;
var map__96111__$1 = cljs.core.__destructure_map(map__96111);
var location__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96111__$1,new cljs.core.Keyword(null,"location","location",1815599388));
var agent_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96111__$1,new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96111__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var radii = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96111__$1,new cljs.core.Keyword(null,"radii","radii",-39552793));
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96111__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96111__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96111__$1,new cljs.core.Keyword(null,"url","url",276297046));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96111__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var ranking = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96111__$1,new cljs.core.Keyword(null,"ranking","ranking",191056920));
var image = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96111__$1,new cljs.core.Keyword(null,"image","image",-58725096));
var place_name = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(pin_form);
var selected_icon = placesurfer.pin_ui.pure.forms.normalize_icon.cljs$core$IFn$_invoke$arity$1(icon);
var group_label = (cljs.core.truth_(pin_group_id)?(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$1(cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__96109_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pin_group_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__96109_SHARP_));
}),pin_group_options)));
