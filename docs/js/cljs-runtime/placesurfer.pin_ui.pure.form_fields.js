...
var G__41285 = e.target.value;
return (set_pin_name_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_name_BANG_.cljs$core$IFn$_invoke$arity$1(G__41285) : set_pin_name_BANG_.call(null,G__41285));
...
var G__41297 = e.target.value;
return (set_pin_address_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_address_BANG_.cljs$core$IFn$_invoke$arity$1(G__41297) : set_pin_address_BANG_.call(null,G__41297));
})], null)], null)], null)], null)], null);
});
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41333),placesurfer$pin_ui$pure$form_fields$icon_row_$_iter__41330(cljs.core.chunk_rest(s__41331__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41333),null);
}
} else {
var filename = cljs.core.first(s__41331__$2);
return cljs.core.cons(placesurfer.pin_ui.pure.form_fields.icon_dropdown_option(filename,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(filename,selected_icon),set_pin_icon_BANG_),placesurfer$pin_ui$pure$form_fields$icon_row_$_iter__41330(cljs.core.rest(s__41331__$2)));
}
} else {
return null;
}
...
var G__41341 = e.target.value;
return (set_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__41341) : set_pin_longitude_BANG_.call(null,G__41341));
}),new cljs.core.Keyword(null,"blur","blur",-453500461),(function (e){
var G__41348 = e.target.value;
return (commit_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? commit_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__41348) : commit_pin_longitude_BANG_.call(null,G__41348));
})], null)], null)], null)], null)], null);
});
...
var G__41356 = e.target.value;
return (set_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__41356) : set_pin_latitude_BANG_.call(null,G__41356));
}),new cljs.core.Keyword(null,"blur","blur",-453500461),(function (e){
var G__41359 = e.target.value;
return (commit_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? commit_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__41359) : commit_pin_latitude_BANG_.call(null,G__41359));
})], null)], null)], null)], null)], null);
});
...
var G__41360 = e.target.value;
return (set_pin_url_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_url_BANG_.cljs$core$IFn$_invoke$arity$1(G__41360) : set_pin_url_BANG_.call(null,G__41360));
})], null)], null)], null)], null)], null);
});
...
var G__41363 = e.target.value;
return (set_pin_image_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_image_BANG_.cljs$core$IFn$_invoke$arity$1(G__41363) : set_pin_image_BANG_.call(null,G__41363));
})], null)], null)], null)], null)], null);
});
...
var G__41368 = e.target.value;
return (set_pin_agent_url_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_agent_url_BANG_.cljs$core$IFn$_invoke$arity$1(G__41368) : set_pin_agent_url_BANG_.call(null,G__41368));
})], null)], null)], null)], null)], null);
});
placesurfer.pin_ui.pure.form_fields.description_row = (function placesurfer$pin_ui$pure$form_fields$description_row(props){
var map__41371 = props;
var map__41371__$1 = cljs.core.__destructure_map(map__41371);
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41371__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var description_edit_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41371__$1,new cljs.core.Keyword(null,"description-edit-mode","description-edit-mode",-1941940982));
var description_sync_token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41371__$1,new cljs.core.Keyword(null,"description-sync-token","description-sync-token",-1307199437));
var set_pin_description_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41371__$1,new cljs.core.Keyword(null,"set-pin-description!","set-pin-description!",-891657600));
var toggle_description_edit_mode_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41371__$1,new cljs.core.Keyword(null,"toggle-description-edit-mode!","toggle-description-edit-mode!",-361122656));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41371__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
var map__41375 = props;
var map__41375__$1 = cljs.core.__destructure_map(map__41375);
var show_pin_group_field_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"show-pin-group-field?","show-pin-group-field?",2032273049));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41375__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
var commit_pin_longitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"commit-pin-longitude!","commit-pin-longitude!",-1228268614));
var pin_items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"pin-items","pin-items",-1214148100));
var pin_editor_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"pin-editor-mode","pin-editor-mode",-577269186));
var set_pin_url_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"set-pin-url!","set-pin-url!",-248892450));
var set_pin_description_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"set-pin-description!","set-pin-description!",-891657600));
var toggle_description_edit_mode_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"toggle-description-edit-mode!","toggle-description-edit-mode!",-361122656));
var set_pin_address_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"set-pin-address!","set-pin-address!",943678529));
var set_pin_name_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"set-pin-name!","set-pin-name!",-689410779));
var set_pin_group_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"set-pin-group!","set-pin-group!",928267686));
var set_pin_icon_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"set-pin-icon!","set-pin-icon!",1169299015));
var set_pin_latitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"set-pin-latitude!","set-pin-latitude!",1547178985));
var pin_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"pin-form","pin-form",1370425130));
var description_edit_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"description-edit-mode","description-edit-mode",-1941940982));
var pin_selected_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"pin-selected-id","pin-selected-id",261877228));
var commit_pin_latitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"commit-pin-latitude!","commit-pin-latitude!",-2003886132));
var set_pin_agent_url_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"set-pin-agent-url!","set-pin-agent-url!",1449358350));
var set_pin_longitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"set-pin-longitude!","set-pin-longitude!",1371393039));
var pin_group_options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"pin-group-options","pin-group-options",550206512));
var description_sync_token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"description-sync-token","description-sync-token",-1307199437));
var pin_group_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"pin-group-id","pin-group-id",-380160105));
var set_pin_image_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41375__$1,new cljs.core.Keyword(null,"set-pin-image!","set-pin-image!",1564686327));
var map__41376 = pin_form;
var map__41376__$1 = cljs.core.__destructure_map(map__41376);
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41376__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41376__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41376__$1,new cljs.core.Keyword(null,"url","url",276297046));
var image = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41376__$1,new cljs.core.Keyword(null,"image","image",-58725096));
var agent_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41376__$1,new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41376__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41376__$1,new cljs.core.Keyword(null,"address","address",559499426));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41376__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
var group_label = (cljs.core.truth_(pin_group_id)?(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$1(cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__41374_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pin_group_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__41374_SHARP_));
}),pin_group_options)));
