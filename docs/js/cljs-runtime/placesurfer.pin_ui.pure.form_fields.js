...
var G__40900 = e.target.value;
return (set_pin_name_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_name_BANG_.cljs$core$IFn$_invoke$arity$1(G__40900) : set_pin_name_BANG_.call(null,G__40900));
...
var G__40912 = e.target.value;
return (set_pin_address_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_address_BANG_.cljs$core$IFn$_invoke$arity$1(G__40912) : set_pin_address_BANG_.call(null,G__40912));
})], null)], null)], null)], null)], null);
});
...
var c__5501__auto__ = cljs.core.chunk_first(s__40996__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__40998 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__40997 = (0);
while(true){
if((i__40997 < size__5502__auto__)){
var filename = cljs.core._nth(c__5501__auto__,i__40997);
cljs.core.chunk_append(b__40998,placesurfer.pin_ui.pure.form_fields.icon_dropdown_option(filename,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(filename,selected_icon),set_pin_icon_BANG_));

var G__41076 = (i__40997 + (1));
i__40997 = G__41076;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40998),placesurfer$pin_ui$pure$form_fields$icon_and_radii_row_$_iter__40995(cljs.core.chunk_rest(s__40996__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40998),null);
}
} else {
var filename = cljs.core.first(s__40996__$2);
return cljs.core.cons(placesurfer.pin_ui.pure.form_fields.icon_dropdown_option(filename,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(filename,selected_icon),set_pin_icon_BANG_),placesurfer$pin_ui$pure$form_fields$icon_and_radii_row_$_iter__40995(cljs.core.rest(s__40996__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41002),placesurfer$pin_ui$pure$form_fields$icon_and_radii_row_$_iter__40999(cljs.core.chunk_rest(s__41000__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41002),null);
}
} else {
var filename = cljs.core.first(s__41000__$2);
return cljs.core.cons(placesurfer.pin_ui.pure.form_fields.stars_dropdown_option(filename,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(filename,selected_ranking),set_pin_stars_BANG_),placesurfer$pin_ui$pure$form_fields$icon_and_radii_row_$_iter__40999(cljs.core.rest(s__41000__$2)));
}
} else {
return null;
}
...
var G__41007 = e.target.value;
return (set_pin_radii_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_radii_BANG_.cljs$core$IFn$_invoke$arity$1(G__41007) : set_pin_radii_BANG_.call(null,G__41007));
})], null)], null)], null)], null)], null);
});
...
var G__41008 = e.target.value;
return (set_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__41008) : set_pin_longitude_BANG_.call(null,G__41008));
}),new cljs.core.Keyword(null,"blur","blur",-453500461),(function (e){
var G__41009 = e.target.value;
return (commit_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? commit_pin_longitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__41009) : commit_pin_longitude_BANG_.call(null,G__41009));
...
var G__41010 = e.target.value;
return (set_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__41010) : set_pin_latitude_BANG_.call(null,G__41010));
}),new cljs.core.Keyword(null,"blur","blur",-453500461),(function (e){
var G__41011 = e.target.value;
return (commit_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1 ? commit_pin_latitude_BANG_.cljs$core$IFn$_invoke$arity$1(G__41011) : commit_pin_latitude_BANG_.call(null,G__41011));
})], null)], null)], null)], null)], null);
});
...
var G__41016 = e.target.value;
return (set_pin_url_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_url_BANG_.cljs$core$IFn$_invoke$arity$1(G__41016) : set_pin_url_BANG_.call(null,G__41016));
...
var G__41019 = e.target.value;
return (set_pin_image_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_image_BANG_.cljs$core$IFn$_invoke$arity$1(G__41019) : set_pin_image_BANG_.call(null,G__41019));
...
var G__41033 = e.target.value;
return (set_pin_agent_url_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_agent_url_BANG_.cljs$core$IFn$_invoke$arity$1(G__41033) : set_pin_agent_url_BANG_.call(null,G__41033));
...
var G__41040 = e.target.value;
return (set_pin_agent_name_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_pin_agent_name_BANG_.cljs$core$IFn$_invoke$arity$1(G__41040) : set_pin_agent_name_BANG_.call(null,G__41040));
...
var map__41049 = props;
var map__41049__$1 = cljs.core.__destructure_map(map__41049);
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41049__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var description_edit_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41049__$1,new cljs.core.Keyword(null,"description-edit-mode","description-edit-mode",-1941940982));
var description_sync_token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41049__$1,new cljs.core.Keyword(null,"description-sync-token","description-sync-token",-1307199437));
var set_pin_description_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41049__$1,new cljs.core.Keyword(null,"set-pin-description!","set-pin-description!",-891657600));
var toggle_description_edit_mode_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41049__$1,new cljs.core.Keyword(null,"toggle-description-edit-mode!","toggle-description-edit-mode!",-361122656));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41049__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
var map__41056 = props;
var map__41056__$1 = cljs.core.__destructure_map(map__41056);
var show_pin_group_field_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"show-pin-group-field?","show-pin-group-field?",2032273049));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41056__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
var commit_pin_longitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"commit-pin-longitude!","commit-pin-longitude!",-1228268614));
var pin_items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"pin-items","pin-items",-1214148100));
var set_pin_agent_name_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-agent-name!","set-pin-agent-name!",1627505212));
var pin_editor_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"pin-editor-mode","pin-editor-mode",-577269186));
var set_pin_url_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-url!","set-pin-url!",-248892450));
var set_pin_description_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-description!","set-pin-description!",-891657600));
var set_pin_radii_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-radii!","set-pin-radii!",1761601184));
var toggle_description_edit_mode_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"toggle-description-edit-mode!","toggle-description-edit-mode!",-361122656));
var set_pin_address_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-address!","set-pin-address!",943678529));
var set_pin_name_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-name!","set-pin-name!",-689410779));
var set_pin_group_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-group!","set-pin-group!",928267686));
var set_pin_icon_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-icon!","set-pin-icon!",1169299015));
var set_pin_latitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-latitude!","set-pin-latitude!",1547178985));
var pin_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"pin-form","pin-form",1370425130));
var description_edit_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"description-edit-mode","description-edit-mode",-1941940982));
var pin_selected_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"pin-selected-id","pin-selected-id",261877228));
var commit_pin_latitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"commit-pin-latitude!","commit-pin-latitude!",-2003886132));
var set_pin_agent_url_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-agent-url!","set-pin-agent-url!",1449358350));
var set_pin_longitude_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-longitude!","set-pin-longitude!",1371393039));
var pin_group_options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"pin-group-options","pin-group-options",550206512));
var set_pin_stars_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-stars!","set-pin-stars!",1351285040));
var description_sync_token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"description-sync-token","description-sync-token",-1307199437));
var pin_group_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"pin-group-id","pin-group-id",-380160105));
var set_pin_image_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41056__$1,new cljs.core.Keyword(null,"set-pin-image!","set-pin-image!",1564686327));
var map__41065 = pin_form;
var map__41065__$1 = cljs.core.__destructure_map(map__41065);
var agent_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"agent-name","agent-name",-916187942));
var location__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"location","location",1815599388));
var agent_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var radii = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"radii","radii",-39552793));
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"url","url",276297046));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var ranking = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"ranking","ranking",191056920));
var image = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41065__$1,new cljs.core.Keyword(null,"image","image",-58725096));
var place_name = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(pin_form);
var selected_icon = placesurfer.pin_ui.pure.forms.normalize_icon.cljs$core$IFn$_invoke$arity$1(icon);
var group_label = (cljs.core.truth_(pin_group_id)?(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$1(cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__41050_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(pin_group_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__41050_SHARP_));
}),pin_group_options)));
