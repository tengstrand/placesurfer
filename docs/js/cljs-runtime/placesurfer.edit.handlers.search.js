...
return placesurfer.edit.handlers.search.swap_render_BANG_((function (p1__41112_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__41112_SHARP_,new cljs.core.Keyword(null,"update-search-results","update-search-results",6100547),results,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"update-search-loading?","update-search-loading?",-489958821),false,new cljs.core.Keyword(null,"update-search-highlight-index","update-search-highlight-index",781350351),placesurfer.pin_ui.interface$.search.highlight_index_for_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([results], 0))], 0));
}));
} else {
return null;
}
...
var map__41113 = cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state);
var map__41113__$1 = cljs.core.__destructure_map(map__41113);
var countries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41113__$1,new cljs.core.Keyword(null,"countries","countries",863192750));
var country_slug = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41113__$1,new cljs.core.Keyword(null,"country-slug","country-slug",769681844));
var country_iso = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41113__$1,new cljs.core.Keyword(null,"country-iso","country-iso",-1029731117));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(placesurfer.app_ui.interface$.state._BANG_state,(function (p1__41114_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__41114_SHARP_,new cljs.core.Keyword(null,"update-search-query","update-search-query",761051950),query),new cljs.core.Keyword(null,"update-search-highlight-index","update-search-highlight-index",781350351),null);
}));

var temp__5825__auto___41138 = cljs.core.deref(placesurfer.edit.handlers.search._BANG_search_timeout);
if(cljs.core.truth_(temp__5825__auto___41138)){
var timeout_41139 = temp__5825__auto___41138;
clearTimeout(timeout_41139);
} else {
}
...
var form_STAR_ = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([form,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),placesurfer.edit.interface$.baseline.coerce_form_text(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(row)),new cljs.core.Keyword(null,"locality","locality",842809377),placesurfer.edit.interface$.baseline.coerce_form_text(new cljs.core.Keyword(null,"locality","locality",842809377).cljs$core$IFn$_invoke$arity$1(row)),new cljs.core.Keyword(null,"homepage","homepage",-1646828249),placesurfer.edit.interface$.baseline.coerce_form_text(new cljs.core.Keyword(null,"homepage","homepage",-1646828249).cljs$core$IFn$_invoke$arity$1(row)),new cljs.core.Keyword(null,"description","description",-1428560544),placesurfer.edit.interface$.baseline.coerce_form_text(new cljs.core.Keyword(null,"description","description",-1428560544).cljs$core$IFn$_invoke$arity$1(row))], null)], 0));
...
var places = (cljs.core.truth_(existing)?cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__41118_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(place__$1),new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__41118_SHARP_))){
return place__$1;
} else {
return p1__41118_SHARP_;
}
...
var map__41123 = cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state);
var map__41123__$1 = cljs.core.__destructure_map(map__41123);
var country_iso = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41123__$1,new cljs.core.Keyword(null,"country-iso","country-iso",-1029731117));
var countries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41123__$1,new cljs.core.Keyword(null,"countries","countries",863192750));
var country_slug = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41123__$1,new cljs.core.Keyword(null,"country-slug","country-slug",769681844));
var update_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41123__$1,new cljs.core.Keyword(null,"update-form","update-form",475718790));
var update_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41123__$1,new cljs.core.Keyword(null,"update-rows","update-rows",-1638458040));
...
return placesurfer.edit.handlers.search.swap_render_BANG_((function (p1__41121_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__41121_SHARP_,new cljs.core.Keyword(null,"update-message","update-message",109684659),placesurfer.edit.handlers.search.outside_country_message);
}));
}
});
...
return placesurfer.edit.handlers.search.swap_render_BANG_((function (p1__41125_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__41125_SHARP_,new cljs.core.Keyword(null,"update-search-highlight-index","update-search-highlight-index",781350351),idx);
}));
});
...
var map__41126 = cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state);
var map__41126__$1 = cljs.core.__destructure_map(map__41126);
var update_search_results = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41126__$1,new cljs.core.Keyword(null,"update-search-results","update-search-results",6100547));
var update_search_highlight_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41126__$1,new cljs.core.Keyword(null,"update-search-highlight-index","update-search-highlight-index",781350351));
...
var map__41128 = cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state);
var map__41128__$1 = cljs.core.__destructure_map(map__41128);
var update_search_results = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41128__$1,new cljs.core.Keyword(null,"update-search-results","update-search-results",6100547));
var update_search_highlight_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41128__$1,new cljs.core.Keyword(null,"update-search-highlight-index","update-search-highlight-index",781350351));
