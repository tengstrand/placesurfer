...
var G__51540__2 = (function (key,params){
...
G__51540 = function(key,params){
switch(arguments.length){
case 1:
return G__51540__1.call(this,key);
case 2:
return G__51540__2.call(this,key,params);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__51540.cljs$core$IFn$_invoke$arity$1 = G__51540__1;
G__51540.cljs$core$IFn$_invoke$arity$2 = G__51540__2;
return G__51540;
})()
], null));
});
...
return cljs.core.vec(cljs.core.keep.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51421_SHARP_){
return placesurfer.edit.interface$.save.row__GT_save_position(country,p1__51421_SHARP_);
}),active),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51422_SHARP_){
return placesurfer.edit.interface$.save.row__GT_save_position(country,p1__51422_SHARP_);
}),tombstones)),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51423_SHARP_){
return placesurfer.edit.interface$.save.row__GT_save_position(country,p1__51423_SHARP_);
}),unchanged_stubs))));
});
...
return placesurfer.edit.interface$.save.canonical_save_positions(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51427_SHARP_){
return placesurfer.edit.interface$.save.row__GT_save_position(country_code,p1__51427_SHARP_);
}),active),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51428_SHARP_){
return placesurfer.edit.interface$.save.row__GT_save_position(country_code,p1__51428_SHARP_);
}),deleted)));
}catch (e51430){var _ = e51430;
return null;
}});
...
if(cljs.core.truth_((function (){var fexpr__51434 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"deleted","deleted",-510100639),null,new cljs.core.Keyword(null,"delete","delete",-1768633620),null], null), null);
return (fexpr__51434.cljs$core$IFn$_invoke$arity$1 ? fexpr__51434.cljs$core$IFn$_invoke$arity$1(action) : fexpr__51434.call(null,action));
})())){
...
placesurfer.edit.handlers.save.restore_update_dataset_from_cache_BANG_ = (function placesurfer$edit$handlers$save$restore_update_dataset_from_cache_BANG_(p__51451){
var map__51452 = p__51451;
var map__51452__$1 = cljs.core.__destructure_map(map__51452);
var clear_selection_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51452__$1,new cljs.core.Keyword(null,"clear-selection?","clear-selection?",624435603),false);
var recenter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51452__$1,new cljs.core.Keyword(null,"recenter?","recenter?",-1643219315),true);
var s = cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state);
var topic = new cljs.core.Keyword(null,"update-topic","update-topic",-406732688).cljs$core$IFn$_invoke$arity$1(s);
var country = new cljs.core.Keyword(null,"update-country-code","update-country-code",1545858722).cljs$core$IFn$_invoke$arity$1(s);
...
var rows = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51459_SHARP_){
return placesurfer.edit.interface$.rows.enrich_row_country_code(p1__51459_SHARP_,country_code);
...
(placesurfer.edit.handlers.save.apply_update_dataset_rows_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (rows,p__51468){
var map__51469 = p__51468;
var map__51469__$1 = cljs.core.__destructure_map(map__51469);
var reset_client_actions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51469__$1,new cljs.core.Keyword(null,"reset-client-actions?","reset-client-actions?",1285612005),false);
var recenter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51469__$1,new cljs.core.Keyword(null,"recenter?","recenter?",-1643219315),true);
...
if(cljs.core.truth_((function (){var G__51471 = new cljs.core.Keyword(null,"action","action",-811238024).cljs$core$IFn$_invoke$arity$1(row);
var fexpr__51470 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"deleted","deleted",-510100639),null,new cljs.core.Keyword(null,"added","added",2057651688),null,new cljs.core.Keyword(null,"edited","edited",-262616624),null], null), null);
...
var row__$1 = (function (){var G__51473 = (function (){var G__51474 = (function (){var G__51475 = enrich_country(row);
if(cljs.core.truth_((function (){var and__5023__auto__ = file_action;
if(cljs.core.truth_(and__5023__auto__)){
return cljs.core.not((function (){var fexpr__51476 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"deleted","deleted",-510100639),null,new cljs.core.Keyword(null,"delete","delete",-1768633620),null], null), null);
return (fexpr__51476.cljs$core$IFn$_invoke$arity$1 ? fexpr__51476.cljs$core$IFn$_invoke$arity$1(file_action) : fexpr__51476.call(null,file_action));
})());
} else {
return and__5023__auto__;
}
})())){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51475,new cljs.core.Keyword(null,"action","action",-811238024),file_action);
} else {
return G__51475;
}
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51474,new cljs.core.Keyword(null,"action","action",-811238024),client_action);
} else {
return G__51474;
}
})();
if(cljs.core.truth_(edited_data)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__51473,edited_data], 0));
} else {
return G__51473;
}
})();
...
if(cljs.core.truth_(temp__5823__auto__)){
var map__51483 = temp__5823__auto__;
var map__51483__$1 = cljs.core.__destructure_map(map__51483);
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51483__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51483__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
...
var map__51504 = ((cljs.core.map_QMARK_(opts))?opts:cljs.core.PersistentArrayMap.EMPTY);
var map__51504__$1 = cljs.core.__destructure_map(map__51504);
var clear_selection_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51504__$1,new cljs.core.Keyword(null,"clear-selection?","clear-selection?",624435603),false);
var recenter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51504__$1,new cljs.core.Keyword(null,"recenter?","recenter?",-1643219315),true);
var force_reload_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51504__$1,new cljs.core.Keyword(null,"force-reload?","force-reload?",-1349067446),false);
var on_complete = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51504__$1,new cljs.core.Keyword(null,"on-complete","on-complete",-1531183971));
var reset_client_actions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51504__$1,new cljs.core.Keyword(null,"reset-client-actions?","reset-client-actions?",1285612005),false);
var map__51505 = cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state);
var map__51505__$1 = cljs.core.__destructure_map(map__51505);
var update_topic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51505__$1,new cljs.core.Keyword(null,"update-topic","update-topic",-406732688));
var update_country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51505__$1,new cljs.core.Keyword(null,"update-country-code","update-country-code",1545858722));
var backend_online_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51505__$1,new cljs.core.Keyword(null,"backend-online?","backend-online?",-200708729));
...
(placesurfer.edit.handlers.save.save_update_dataset_BANG_.cljs$core$IFn$_invoke$arity$1 = (function (p__51534){
var map__51535 = p__51534;
var map__51535__$1 = cljs.core.__destructure_map(map__51535);
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51535__$1,new cljs.core.Keyword(null,"on-success","on-success",1786904109));
var on_failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51535__$1,new cljs.core.Keyword(null,"on-failure","on-failure",842888245));
...
var map__51537 = cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state);
var map__51537__$1 = cljs.core.__destructure_map(map__51537);
var backend_online_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51537__$1,new cljs.core.Keyword(null,"backend-online?","backend-online?",-200708729));
var update_topic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51537__$1,new cljs.core.Keyword(null,"update-topic","update-topic",-406732688));
var update_country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51537__$1,new cljs.core.Keyword(null,"update-country-code","update-country-code",1545858722));
var update_selected_row_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51537__$1,new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563));
var update_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51537__$1,new cljs.core.Keyword(null,"update-columns","update-columns",666065227));
var update_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51537__$1,new cljs.core.Keyword(null,"update-form","update-form",475718790));
var map__51538 = update_form;
var map__51538__$1 = cljs.core.__destructure_map(map__51538);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51538__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var location__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51538__$1,new cljs.core.Keyword(null,"location","location",1815599388));
var homepage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51538__$1,new cljs.core.Keyword(null,"homepage","homepage",-1646828249));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51538__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51538__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51538__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var source = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51538__$1,new cljs.core.Keyword(null,"source","source",-433931539));
...
var G__51539__$1 = ((cljs.core.seq(clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(homepage))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51539,new cljs.core.Keyword(null,"homepage","homepage",-1646828249),clojure.string.trim(homepage)):G__51539);
if(cljs.core.seq(clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(description)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51539__$1,new cljs.core.Keyword(null,"description","description",-1428560544),clojure.string.trim(description));
} else {
return G__51539__$1;
}
})()], null);
