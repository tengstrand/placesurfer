...
placesurfer.edit.handlers.save.auto_select_for_topic = (function placesurfer$edit$handlers$save$auto_select_for_topic(s){
...
var target = (function (){var or__5025__auto__ = (cljs.core.truth_(remembered_id)?cljs.core.some((function (p1__78325_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(remembered_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__78325_SHARP_))){
...
return cljs.core.first(display);
}
})();
if(cljs.core.truth_(target)){
var G__78327 = placesurfer.edit.handlers.rows.select_update_row_in_state(s,target);
if(cljs.core.truth_(topic)){
return cljs.core.assoc_in(G__78327,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"update-topic-row-memory","update-topic-row-memory",570329424),topic], null),new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(target));
} else {
return G__78327;
}
} else {
...
var G__78480__2 = (function (key,params){
...
G__78480 = function(key,params){
switch(arguments.length){
case 1:
return G__78480__1.call(this,key);
case 2:
return G__78480__2.call(this,key,params);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__78480.cljs$core$IFn$_invoke$arity$1 = G__78480__1;
G__78480.cljs$core$IFn$_invoke$arity$2 = G__78480__2;
return G__78480;
})()
], null));
});
...
return cljs.core.vec(cljs.core.keep.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__78328_SHARP_){
return placesurfer.edit.interface$.save.row__GT_save_position(country,p1__78328_SHARP_);
}),active),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__78329_SHARP_){
return placesurfer.edit.interface$.save.row__GT_save_position(country,p1__78329_SHARP_);
}),tombstones)),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__78330_SHARP_){
return placesurfer.edit.interface$.save.row__GT_save_position(country,p1__78330_SHARP_);
}),unchanged_stubs))));
});
...
return placesurfer.edit.interface$.save.canonical_save_positions(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__78334_SHARP_){
return placesurfer.edit.interface$.save.row__GT_save_position(country_code,p1__78334_SHARP_);
}),active),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__78335_SHARP_){
return placesurfer.edit.interface$.save.row__GT_save_position(country_code,p1__78335_SHARP_);
}),deleted)));
}catch (e78339){var _ = e78339;
return null;
}});
...
placesurfer.edit.handlers.save.client_deleted_preserve_keys = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 16, [new cljs.core.Keyword(null,"description","description",-1428560544),null,new cljs.core.Keyword(null,"layout-par","layout-par",-441618202),null,new cljs.core.Keyword(null,"homepage","homepage",-1646828249),null,new cljs.core.Keyword(null,"name","name",1843675177),null,new cljs.core.Keyword(null,"layout-name","layout-name",-861676759),null,new cljs.core.Keyword(null,"country-code","country-code",-927451124),null,new cljs.core.Keyword(null,"longitude","longitude",-1268876372),null,new cljs.core.Keyword(null,"source","source",-433931539),null,new cljs.core.Keyword(null,"holes","holes",188002959),null,new cljs.core.Keyword(null,"layout-holes","layout-holes",-1095137739),null,new cljs.core.Keyword(null,"layout-length-meters","layout-length-meters",-1184590826),null,new cljs.core.Keyword(null,"latitude","latitude",394867543),null,new cljs.core.Keyword(null,"image","image",-58725096),null,new cljs.core.Keyword(null,"action","action",-811238024),null,new cljs.core.Keyword(null,"location","location",1815599388),null,new cljs.core.Keyword(null,"region-code","region-code",-1558201506),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__78349 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"deleted","deleted",-510100639),null,new cljs.core.Keyword(null,"delete","delete",-1768633620),null], null), null);
return (fexpr__78349.cljs$core$IFn$_invoke$arity$1 ? fexpr__78349.cljs$core$IFn$_invoke$arity$1(action) : fexpr__78349.call(null,action));
})())){
...
placesurfer.edit.handlers.save.restore_update_dataset_from_cache_BANG_ = (function placesurfer$edit$handlers$save$restore_update_dataset_from_cache_BANG_(p__78366){
var map__78367 = p__78366;
var map__78367__$1 = cljs.core.__destructure_map(map__78367);
var clear_selection_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__78367__$1,new cljs.core.Keyword(null,"clear-selection?","clear-selection?",624435603),false);
var recenter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__78367__$1,new cljs.core.Keyword(null,"recenter?","recenter?",-1643219315),true);
var s = cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state);
var topic = new cljs.core.Keyword(null,"update-topic","update-topic",-406732688).cljs$core$IFn$_invoke$arity$1(s);
var country = new cljs.core.Keyword(null,"update-country-code","update-country-code",1545858722).cljs$core$IFn$_invoke$arity$1(s);
...
var rows = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__78369_SHARP_){
return placesurfer.edit.interface$.rows.enrich_row_country_code(p1__78369_SHARP_,country_code);
...
(placesurfer.edit.handlers.save.apply_update_dataset_rows_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (rows,p__78404){
var map__78405 = p__78404;
var map__78405__$1 = cljs.core.__destructure_map(map__78405);
var reset_client_actions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__78405__$1,new cljs.core.Keyword(null,"reset-client-actions?","reset-client-actions?",1285612005),false);
var recenter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__78405__$1,new cljs.core.Keyword(null,"recenter?","recenter?",-1643219315),true);
...
if(cljs.core.truth_((function (){var G__78414 = new cljs.core.Keyword(null,"action","action",-811238024).cljs$core$IFn$_invoke$arity$1(row);
var fexpr__78413 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"deleted","deleted",-510100639),null,new cljs.core.Keyword(null,"added","added",2057651688),null,new cljs.core.Keyword(null,"edited","edited",-262616624),null], null), null);
return (fexpr__78413.cljs$core$IFn$_invoke$arity$1 ? fexpr__78413.cljs$core$IFn$_invoke$arity$1(G__78414) : fexpr__78413.call(null,G__78414));
})())){
...
var row__$1 = (function (){var G__78418 = (function (){var G__78419 = (function (){var G__78420 = enrich_country(row);
if(cljs.core.truth_((function (){var and__5023__auto__ = file_action;
if(cljs.core.truth_(and__5023__auto__)){
return cljs.core.not((function (){var fexpr__78421 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"deleted","deleted",-510100639),null,new cljs.core.Keyword(null,"delete","delete",-1768633620),null], null), null);
return (fexpr__78421.cljs$core$IFn$_invoke$arity$1 ? fexpr__78421.cljs$core$IFn$_invoke$arity$1(file_action) : fexpr__78421.call(null,file_action));
})());
} else {
return and__5023__auto__;
}
})())){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__78420,new cljs.core.Keyword(null,"action","action",-811238024),file_action);
} else {
return G__78420;
}
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__78419,new cljs.core.Keyword(null,"action","action",-811238024),client_action);
} else {
return G__78419;
}
})();
if(cljs.core.truth_(edited_data)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__78418,edited_data], 0));
} else {
return G__78418;
}
})();
...
if(cljs.core.truth_(temp__5823__auto__)){
var map__78425 = temp__5823__auto__;
var map__78425__$1 = cljs.core.__destructure_map(map__78425);
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78425__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78425__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
...
var s__$4 = (((new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563).cljs$core$IFn$_invoke$arity$1(s__$3) == null))?placesurfer.edit.handlers.save.auto_select_for_topic(s__$3):s__$3);
return s__$4;
}));
...
var map__78451 = ((cljs.core.map_QMARK_(opts))?opts:cljs.core.PersistentArrayMap.EMPTY);
var map__78451__$1 = cljs.core.__destructure_map(map__78451);
var clear_selection_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__78451__$1,new cljs.core.Keyword(null,"clear-selection?","clear-selection?",624435603),false);
var recenter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__78451__$1,new cljs.core.Keyword(null,"recenter?","recenter?",-1643219315),true);
var force_reload_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__78451__$1,new cljs.core.Keyword(null,"force-reload?","force-reload?",-1349067446),false);
var on_complete = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78451__$1,new cljs.core.Keyword(null,"on-complete","on-complete",-1531183971));
var reset_client_actions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__78451__$1,new cljs.core.Keyword(null,"reset-client-actions?","reset-client-actions?",1285612005),false);
var map__78452 = cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state);
var map__78452__$1 = cljs.core.__destructure_map(map__78452);
var update_topic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78452__$1,new cljs.core.Keyword(null,"update-topic","update-topic",-406732688));
var update_country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78452__$1,new cljs.core.Keyword(null,"update-country-code","update-country-code",1545858722));
var backend_online_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78452__$1,new cljs.core.Keyword(null,"backend-online?","backend-online?",-200708729));
...
(placesurfer.edit.handlers.save.save_update_dataset_BANG_.cljs$core$IFn$_invoke$arity$1 = (function (p__78465){
var map__78466 = p__78465;
var map__78466__$1 = cljs.core.__destructure_map(map__78466);
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78466__$1,new cljs.core.Keyword(null,"on-success","on-success",1786904109));
var on_failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78466__$1,new cljs.core.Keyword(null,"on-failure","on-failure",842888245));
...
var map__78469 = cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state);
var map__78469__$1 = cljs.core.__destructure_map(map__78469);
var backend_online_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78469__$1,new cljs.core.Keyword(null,"backend-online?","backend-online?",-200708729));
var update_topic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78469__$1,new cljs.core.Keyword(null,"update-topic","update-topic",-406732688));
var update_country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78469__$1,new cljs.core.Keyword(null,"update-country-code","update-country-code",1545858722));
var update_selected_row_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78469__$1,new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563));
var update_columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78469__$1,new cljs.core.Keyword(null,"update-columns","update-columns",666065227));
var update_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78469__$1,new cljs.core.Keyword(null,"update-form","update-form",475718790));
var map__78470 = update_form;
var map__78470__$1 = cljs.core.__destructure_map(map__78470);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78470__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var location__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78470__$1,new cljs.core.Keyword(null,"location","location",1815599388));
var homepage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78470__$1,new cljs.core.Keyword(null,"homepage","homepage",-1646828249));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78470__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78470__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78470__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var source = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78470__$1,new cljs.core.Keyword(null,"source","source",-433931539));
...
var G__78471__$1 = ((cljs.core.seq(clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(homepage))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__78471,new cljs.core.Keyword(null,"homepage","homepage",-1646828249),clojure.string.trim(homepage)):G__78471);
if(cljs.core.seq(clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(description)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__78471__$1,new cljs.core.Keyword(null,"description","description",-1428560544),clojure.string.trim(description));
} else {
return G__78471__$1;
}
})()], null);
