goog.provide('placesurfer.edit.pure.cells');
placesurfer.edit.pure.cells.display_cell_value = (function placesurfer$edit$pure$cells$display_cell_value(v){
if((v == null)){
return "";
} else {
...
placesurfer.edit.pure.cells.source_label = (function placesurfer$edit$pure$cells$source_label(source){
...
placesurfer.edit.pure.cells.row_marker_icon_src = (function placesurfer$edit$pure$cells$row_marker_icon_src(values){
 ...
 */
placesurfer.edit.pure.cells.source_cell_icon_src = (function placesurfer$edit$pure$cells$source_cell_icon_src(values){
var or__5025__auto__ = placesurfer.edit.pure.cells.source_icon_src(new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(values));
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return placesurfer.edit.pure.cells.row_marker_icon_src(values);
}
});
placesurfer.edit.pure.cells.source_display_name = (function placesurfer$edit$pure$cells$source_display_name(source){
return placesurfer.edit.pure.cells.source_label(source);
});
placesurfer.edit.pure.cells.sort_indicator = (function placesurfer$edit$pure$cells$sort_indicator(sort_field,sort_dir,column_key){
...
placesurfer.edit.pure.cells.table_column_header = (function placesurfer$edit$pure$cells$table_column_header(key,label,sort_field,sort_dir){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(key,new cljs.core.Keyword(null,"action-icon","action-icon",-355725910))){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.update-action-header-label","span.update-action-header-label",-63597784),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img.update-action-header-icon","img.update-action-header-icon",691410403),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),"/images/flash.png",new cljs.core.Keyword(null,"alt","alt",-3214426),"Action"], null)], null),placesurfer.edit.pure.cells.sort_indicator(sort_field,sort_dir,key)], null);
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(label),(function (){var or__5025__auto__ = placesurfer.edit.pure.cells.sort_indicator(sort_field,sort_dir,key);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return "";
...
placesurfer.edit.pure.cells.table_cell = (function placesurfer$edit$pure$cells$table_cell(row_id,values,key){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(key,new cljs.core.Keyword(null,"action-icon","action-icon",-355725910))){
...
})()),new cljs.core.Keyword(null,"title","title",636505583),placesurfer.edit.pure.cells.display_cell_value((function (){var or__5025__auto__ = new cljs.core.Keyword(null,"source","source",-433931539).cljs$core$IFn$_invoke$arity$1(values);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return "place";
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.update-meters-cell","td.update-meters-cell",-712102261),placesurfer.edit.pure.cells.display_cell_value(cljs.core.get.cljs$core$IFn$_invoke$arity$2(values,key))], null);
} else {
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),placesurfer.edit.pure.cells.display_cell_value(cljs.core.get.cljs$core$IFn$_invoke$arity$2(values,key))], null);
...
//# sourceMappingURL=placesurfer.edit.pure.cells.js.map
