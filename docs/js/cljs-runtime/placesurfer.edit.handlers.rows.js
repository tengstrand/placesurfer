...
if((!((row_id == null)))){
return cljs.core.some((function (p1__39498_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__39498_SHARP_))){
return p1__39498_SHARP_;
} else {
return null;
}
...
return cljs.core.some((function (p1__39505_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__39505_SHARP_))){
return placesurfer.edit.interface$.rows.pending_place__GT_row(p1__39505_SHARP_);
} else {
return null;
}
...
var G__39729__2 = (function (key,params){
...
G__39729 = function(key,params){
switch(arguments.length){
case 1:
return G__39729__1.call(this,key);
case 2:
return G__39729__2.call(this,key,params);
}
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__39579_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__39579_SHARP_))){
return placesurfer.edit.handlers.rows.apply_edited_action_to_row(p1__39579_SHARP_,form,disk_baseline,field_errors);
} else {
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__39581_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__39581_SHARP_))){
return placesurfer.edit.handlers.rows.apply_edited_action_to_pending(p1__39581_SHARP_,form,disk_baseline,field_errors,draft_validation_QMARK_);
} else {
return p1__39581_SHARP_;
}
}),places);
}));
...
var len__5749__auto___39734 = arguments.length;
var i__5750__auto___39735 = (0);
while(true){
if((i__5750__auto___39735 < len__5749__auto___39734)){
args__5755__auto__.push((arguments[i__5750__auto___39735]));

var G__39736 = (i__5750__auto___39735 + (1));
i__5750__auto___39735 = G__39736;
continue;
} else {
}
break;
...
(placesurfer.edit.handlers.rows.find_display_row_in_state.cljs$core$IFn$_invoke$arity$variadic = (function (s,longitude,latitude,p__39589){
var vec__39590 = p__39589;
var use_url_name_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39590,(0),null);
...
/** @this {Function} */
(placesurfer.edit.handlers.rows.find_display_row_in_state.cljs$lang$applyTo = (function (seq39584){
...
var G__39587 = cljs.core.first(seq39584__$2);
var seq39584__$3 = cljs.core.next(seq39584__$2);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39585,G__39586,G__39587,seq39584__$3);
}));
...
var disk_baseline = new cljs.core.Keyword(null,"update-disk-baseline","update-disk-baseline",-1912505529).cljs$core$IFn$_invoke$arity$1(s);
var row = cljs.core.some((function (p1__39595_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__39595_SHARP_))){
return p1__39595_SHARP_;
} else {
return null;
}
...
var disk_baseline = new cljs.core.Keyword(null,"update-disk-baseline","update-disk-baseline",-1912505529).cljs$core$IFn$_invoke$arity$1(s);
var s__$1 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.Keyword(null,"update-rows","update-rows",-1638458040),(function (rows){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__39621_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__39621_SHARP_))){
return placesurfer.edit.handlers.rows.row_from_disk_baseline_entry(p1__39621_SHARP_,baseline,disk_baseline);
} else {
return p1__39621_SHARP_;
}
}),rows);
}));
var row = cljs.core.some((function (p1__39622_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__39622_SHARP_))){
return p1__39622_SHARP_;
} else {
return null;
}
...
var disk_baseline = new cljs.core.Keyword(null,"update-disk-baseline","update-disk-baseline",-1912505529).cljs$core$IFn$_invoke$arity$1(s);
var s__$1 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.Keyword(null,"update-pending-places","update-pending-places",-1248905352),(function (places){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__39649_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__39649_SHARP_))){
return placesurfer.edit.interface$.rows.recompute_row_action(placesurfer.edit.interface$.rows.pending_place_from_form_baseline(p1__39649_SHARP_,baseline),disk_baseline);
} else {
return p1__39649_SHARP_;
}
}),places);
}));
...
var args__5755__auto__ = [];
var len__5749__auto___39738 = arguments.length;
var i__5750__auto___39739 = (0);
while(true){
if((i__5750__auto___39739 < len__5749__auto___39738)){
args__5755__auto__.push((arguments[i__5750__auto___39739]));

var G__39740 = (i__5750__auto___39739 + (1));
i__5750__auto___39739 = G__39740;
continue;
} else {
}
break;
...
(placesurfer.edit.handlers.rows.toggle_row_delete_action_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (row,disk_baseline,p__39661){
var map__39662 = p__39661;
var map__39662__$1 = cljs.core.__destructure_map(map__39662);
var country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39662__$1,new cljs.core.Keyword(null,"country-code","country-code",-927451124));
...
/** @this {Function} */
(placesurfer.edit.handlers.rows.toggle_row_delete_action_BANG_.cljs$lang$applyTo = (function (seq39658){
...
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39659,G__39660,seq39658__$2);
}));
...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__39663_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__39663_SHARP_));
}),places));
})),new cljs.core.Keyword(null,"update-rows","update-rows",-1638458040),(function (rows){
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__39664_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__39664_SHARP_));
}),rows));
...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__39667_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__39667_SHARP_));
}),rs));
...
var saved_url_draft_39746 = new cljs.core.Keyword(null,"update-url-form","update-url-form",-125092673).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state));
var saved_pending_39747 = new cljs.core.Keyword(null,"update-pending-places","update-pending-places",-1248905352).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state));
var form_39748 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(placesurfer.edit.interface$.baseline.row__GT_form_baseline(row),new cljs.core.Keyword(null,"google-url","google-url",1168346589),"");
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(placesurfer.app_ui.interface$.state._BANG_state,(function (s){
return placesurfer.app_ui.interface$.state.bump_description_sync_token((function (){var G__39693 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(s,new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563),row_id,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"update-selected-row","update-selected-row",-1179126191),row,new cljs.core.Keyword(null,"update-row-baseline","update-row-baseline",-1034088672),placesurfer.edit.interface$.baseline.row__GT_form_baseline(row),new cljs.core.Keyword(null,"update-form","update-form",475718790),form_39748,new cljs.core.Keyword(null,"update-form-field-errors","update-form-field-errors",-1735528956),placesurfer.edit.handlers.rows.compute_update_form_field_errors_for_state(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(s,new cljs.core.Keyword(null,"update-form","update-form",475718790),form_39748,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563),row_id,new cljs.core.Keyword(null,"update-selected-row","update-selected-row",-1179126191),row], 0)))], 0));
var G__39693__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"url-form","url-form",426694546).cljs$core$IFn$_invoke$arity$1(row))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39693,new cljs.core.Keyword(null,"update-url-form","update-url-form",-125092673),new cljs.core.Keyword(null,"url-form","url-form",426694546).cljs$core$IFn$_invoke$arity$1(row)):G__39693);
if(cljs.core.truth_((function (){var and__5023__auto__ = saved_url_draft_39746;
if(cljs.core.truth_(and__5023__auto__)){
return placesurfer.edit.interface$.rows.saved_update_row_id_QMARK_(row_id);
} else {
return and__5023__auto__;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__39693__$1,new cljs.core.Keyword(null,"update-url-form","update-url-form",-125092673),saved_url_draft_39746,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"update-pending-places","update-pending-places",-1248905352),saved_pending_39747], 0));
} else {
return G__39693__$1;
}
})());
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__39694_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__39694_SHARP_))){
return placesurfer.edit.handlers.rows.toggle_row_delete_action_BANG_.cljs$core$IFn$_invoke$arity$variadic(p1__39694_SHARP_,disk_baseline,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"country-code","country-code",-927451124),country_code], 0));
} else {
return p1__39694_SHARP_;
}
}),rows__$1);
}));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(placesurfer.app_ui.interface$.state._BANG_state,cljs.core.update,new cljs.core.Keyword(null,"update-sort","update-sort",-1611336622),(function (p__39705){
var map__39707 = p__39705;
var map__39707__$1 = cljs.core.__destructure_map(map__39707);
var field = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39707__$1,new cljs.core.Keyword(null,"field","field",-1302436500));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39707__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
...
var G__39717 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.Keyword(null,"update-show-duplicates?","update-show-duplicates?",962796900),cljs.core.not),new cljs.core.Keyword(null,"update-table-scroll-token","update-table-scroll-token",903188454),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.inc,(0)));
var G__39717__$1 = ((enabling_QMARK_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39717,new cljs.core.Keyword(null,"update-sort-before-duplicates","update-sort-before-duplicates",-192409059),new cljs.core.Keyword(null,"update-sort","update-sort",-1611336622).cljs$core$IFn$_invoke$arity$1(s)):G__39717);
if((!(enabling_QMARK_))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39717__$1,new cljs.core.Keyword(null,"update-sort","update-sort",-1611336622),(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"update-sort-before-duplicates","update-sort-before-duplicates",-192409059).cljs$core$IFn$_invoke$arity$1(s);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var map__39722 = s;
var map__39722__$1 = cljs.core.__destructure_map(map__39722);
var update_selected_row_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39722__$1,new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563));
var update_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39722__$1,new cljs.core.Keyword(null,"update-form","update-form",475718790));
