...
if((!((row_id == null)))){
return cljs.core.some((function (p1__47174_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__47174_SHARP_))){
return p1__47174_SHARP_;
} else {
return null;
}
...
return cljs.core.some((function (p1__47178_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__47178_SHARP_))){
return placesurfer.edit.interface$.rows.pending_place__GT_row(p1__47178_SHARP_);
} else {
return null;
}
...
var G__47391__2 = (function (key,params){
...
G__47391 = function(key,params){
switch(arguments.length){
case 1:
return G__47391__1.call(this,key);
case 2:
return G__47391__2.call(this,key,params);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__47391.cljs$core$IFn$_invoke$arity$1 = G__47391__1;
G__47391.cljs$core$IFn$_invoke$arity$2 = G__47391__2;
return G__47391;
})()
;
...
return new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"pending-id","pending-id",1999041996),placesurfer.edit.handlers.rows.next_pending_row_id_BANG_(),new cljs.core.Keyword(null,"name","name",1843675177),"",new cljs.core.Keyword(null,"locality","locality",842809377),"",new cljs.core.Keyword(null,"description","description",-1428560544),"",new cljs.core.Keyword(null,"source","source",-433931539),new cljs.core.Keyword(null,"manual","manual",-237370608),new cljs.core.Keyword(null,"action","action",-811238024),new cljs.core.Keyword(null,"added","added",2057651688)], null);
}
})();
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__47200_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__47200_SHARP_))){
return placesurfer.edit.handlers.rows.apply_edited_action_to_row(p1__47200_SHARP_,form,disk_baseline,field_errors);
} else {
return p1__47200_SHARP_;
}
}),rows);
}));
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__47201_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__47201_SHARP_))){
return placesurfer.edit.handlers.rows.apply_edited_action_to_pending(p1__47201_SHARP_,form,disk_baseline,field_errors,draft_validation_QMARK_);
} else {
return p1__47201_SHARP_;
}
}),places);
}));
...
var len__5749__auto___47423 = arguments.length;
var i__5750__auto___47424 = (0);
while(true){
if((i__5750__auto___47424 < len__5749__auto___47423)){
args__5755__auto__.push((arguments[i__5750__auto___47424]));

var G__47425 = (i__5750__auto___47424 + (1));
i__5750__auto___47424 = G__47425;
continue;
} else {
}
break;
...
(placesurfer.edit.handlers.rows.find_display_row_in_state.cljs$core$IFn$_invoke$arity$variadic = (function (s,longitude,latitude,p__47218){
var vec__47220 = p__47218;
var use_url_name_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47220,(0),null);
...
/** @this {Function} */
(placesurfer.edit.handlers.rows.find_display_row_in_state.cljs$lang$applyTo = (function (seq47213){
var G__47214 = cljs.core.first(seq47213);
var seq47213__$1 = cljs.core.next(seq47213);
var G__47215 = cljs.core.first(seq47213__$1);
var seq47213__$2 = cljs.core.next(seq47213__$1);
var G__47216 = cljs.core.first(seq47213__$2);
var seq47213__$3 = cljs.core.next(seq47213__$2);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47214,G__47215,G__47216,seq47213__$3);
}));
...
var disk_baseline = new cljs.core.Keyword(null,"update-disk-baseline","update-disk-baseline",-1912505529).cljs$core$IFn$_invoke$arity$1(s);
var row = cljs.core.some((function (p1__47228_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__47228_SHARP_))){
...
var disk_baseline = new cljs.core.Keyword(null,"update-disk-baseline","update-disk-baseline",-1912505529).cljs$core$IFn$_invoke$arity$1(s);
var s__$1 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.Keyword(null,"update-rows","update-rows",-1638458040),(function (rows){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__47247_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__47247_SHARP_))){
return placesurfer.edit.handlers.rows.row_from_disk_baseline_entry(p1__47247_SHARP_,baseline,disk_baseline);
} else {
return p1__47247_SHARP_;
}
}),rows);
}));
var row = cljs.core.some((function (p1__47248_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__47248_SHARP_))){
...
var disk_baseline = new cljs.core.Keyword(null,"update-disk-baseline","update-disk-baseline",-1912505529).cljs$core$IFn$_invoke$arity$1(s);
var s__$1 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.Keyword(null,"update-pending-places","update-pending-places",-1248905352),(function (places){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__47255_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__47255_SHARP_))){
return placesurfer.edit.interface$.rows.recompute_row_action(placesurfer.edit.interface$.rows.pending_place_from_form_baseline(p1__47255_SHARP_,baseline),disk_baseline);
} else {
return p1__47255_SHARP_;
}
}),places);
}));
...
var args__5755__auto__ = [];
var len__5749__auto___47449 = arguments.length;
var i__5750__auto___47450 = (0);
while(true){
if((i__5750__auto___47450 < len__5749__auto___47449)){
args__5755__auto__.push((arguments[i__5750__auto___47450]));

var G__47451 = (i__5750__auto___47450 + (1));
i__5750__auto___47450 = G__47451;
continue;
} else {
}
break;
...
(placesurfer.edit.handlers.rows.toggle_row_delete_action_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (row,disk_baseline,p__47278){
var map__47279 = p__47278;
var map__47279__$1 = cljs.core.__destructure_map(map__47279);
var country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47279__$1,new cljs.core.Keyword(null,"country-code","country-code",-927451124));
...
/** @this {Function} */
(placesurfer.edit.handlers.rows.toggle_row_delete_action_BANG_.cljs$lang$applyTo = (function (seq47269){
var G__47270 = cljs.core.first(seq47269);
var seq47269__$1 = cljs.core.next(seq47269);
var G__47271 = cljs.core.first(seq47269__$1);
var seq47269__$2 = cljs.core.next(seq47269__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47270,G__47271,seq47269__$2);
}));
...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__47281_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__47281_SHARP_));
}),places));
})),new cljs.core.Keyword(null,"update-rows","update-rows",-1638458040),(function (rows){
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__47282_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__47282_SHARP_));
}),rows));
...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__47290_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__47290_SHARP_));
}),rs));
...
var saved_url_draft_47454 = new cljs.core.Keyword(null,"update-url-form","update-url-form",-125092673).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state));
var saved_pending_47456 = new cljs.core.Keyword(null,"update-pending-places","update-pending-places",-1248905352).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state));
var form_47457 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(placesurfer.edit.interface$.baseline.row__GT_form_baseline(row),new cljs.core.Keyword(null,"google-url","google-url",1168346589),"");
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(placesurfer.app_ui.interface$.state._BANG_state,(function (s){
return placesurfer.app_ui.interface$.state.bump_description_sync_token((function (){var G__47332 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(s,new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563),row_id,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"update-selected-row","update-selected-row",-1179126191),row,new cljs.core.Keyword(null,"update-row-baseline","update-row-baseline",-1034088672),placesurfer.edit.interface$.baseline.row__GT_form_baseline(row),new cljs.core.Keyword(null,"update-form","update-form",475718790),form_47457,new cljs.core.Keyword(null,"update-form-field-errors","update-form-field-errors",-1735528956),placesurfer.edit.handlers.rows.compute_update_form_field_errors_for_state(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(s,new cljs.core.Keyword(null,"update-form","update-form",475718790),form_47457,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563),row_id,new cljs.core.Keyword(null,"update-selected-row","update-selected-row",-1179126191),row], 0)))], 0));
var G__47332__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"url-form","url-form",426694546).cljs$core$IFn$_invoke$arity$1(row))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47332,new cljs.core.Keyword(null,"update-url-form","update-url-form",-125092673),new cljs.core.Keyword(null,"url-form","url-form",426694546).cljs$core$IFn$_invoke$arity$1(row)):G__47332);
if(cljs.core.truth_((function (){var and__5023__auto__ = saved_url_draft_47454;
if(cljs.core.truth_(and__5023__auto__)){
return placesurfer.edit.interface$.rows.saved_update_row_id_QMARK_(row_id);
} else {
return and__5023__auto__;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__47332__$1,new cljs.core.Keyword(null,"update-url-form","update-url-form",-125092673),saved_url_draft_47454,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"update-pending-places","update-pending-places",-1248905352),saved_pending_47456], 0));
} else {
return G__47332__$1;
}
})());
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__47345_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__47345_SHARP_))){
return placesurfer.edit.handlers.rows.toggle_row_delete_action_BANG_.cljs$core$IFn$_invoke$arity$variadic(p1__47345_SHARP_,disk_baseline,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"country-code","country-code",-927451124),country_code], 0));
} else {
return p1__47345_SHARP_;
}
}),rows__$1);
}));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(placesurfer.app_ui.interface$.state._BANG_state,cljs.core.update,new cljs.core.Keyword(null,"update-sort","update-sort",-1611336622),(function (p__47354){
var map__47355 = p__47354;
var map__47355__$1 = cljs.core.__destructure_map(map__47355);
var field = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47355__$1,new cljs.core.Keyword(null,"field","field",-1302436500));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47355__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
...
var G__47358 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.Keyword(null,"update-show-duplicates?","update-show-duplicates?",962796900),cljs.core.not),new cljs.core.Keyword(null,"update-table-scroll-token","update-table-scroll-token",903188454),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.inc,(0)));
var G__47358__$1 = ((enabling_QMARK_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47358,new cljs.core.Keyword(null,"update-sort-before-duplicates","update-sort-before-duplicates",-192409059),new cljs.core.Keyword(null,"update-sort","update-sort",-1611336622).cljs$core$IFn$_invoke$arity$1(s)):G__47358);
if((!(enabling_QMARK_))){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47358__$1,new cljs.core.Keyword(null,"update-sort","update-sort",-1611336622),(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"update-sort-before-duplicates","update-sort-before-duplicates",-192409059).cljs$core$IFn$_invoke$arity$1(s);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var update_selected_row_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47374__$1,new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563));
var update_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47374__$1,new cljs.core.Keyword(null,"update-form","update-form",475718790));
