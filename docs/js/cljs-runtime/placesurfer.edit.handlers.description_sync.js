goog.provide('placesurfer.edit.handlers.description_sync');
placesurfer.edit.handlers.description_sync.dom_available_QMARK_ = (function placesurfer$edit$handlers$description_sync$dom_available_QMARK_(){
...
return placesurfer.html.interface$.description.description_for_text_display.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"update-row-baseline","update-row-baseline",-1034088672),new cljs.core.Keyword(null,"description","description",-1428560544)], null),"")))], 0));
});
placesurfer.edit.handlers.description_sync.description_editor_differs_from_baseline_QMARK_ = (function placesurfer$edit$handlers$description_sync$description_editor_differs_from_baseline_QMARK_(s){
if(cljs.core.truth_((function (){var and__5023__auto__ = placesurfer.edit.handlers.description_sync.dom_available_QMARK_();
if(cljs.core.truth_(and__5023__auto__)){
...
placesurfer.edit.handlers.description_sync.flush_update_description_from_dom_BANG_ = (function placesurfer$edit$handlers$description_sync$flush_update_description_from_dom_BANG_(){

if(cljs.core.truth_((function (){var and__5023__auto__ = placesurfer.edit.handlers.description_sync.dom_available_QMARK_();
if(cljs.core.truth_(and__5023__auto__)){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update","update",1045576396),new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state)))) && ((!((new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state)) == null)))));
} else {
return and__5023__auto__;
}
})())){
...
var canonical = placesurfer.html.interface$.description_field.read_editor_canonical.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([el], 0));
...
//# sourceMappingURL=placesurfer.edit.handlers.description_sync.js.map
