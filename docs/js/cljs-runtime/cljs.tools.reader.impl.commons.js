...
var G__38141 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__38141;
continue;
} else {
return ch;
...
var vec__38076 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38076,(0),null);
return (match === s);
});
...
var G__38165 = (i__5750__auto___38164 + (1));
i__5750__auto___38164 = G__38165;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq38107){
...
return (function() { 
var G__38171__delegate = function (rdr,_){
...
var G__38171 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__38173__i = 0, G__38173__a = new Array(arguments.length -  1);
while (G__38173__i < G__38173__a.length) {G__38173__a[G__38173__i] = arguments[G__38173__i + 1]; ++G__38173__i;}
  _ = new cljs.core.IndexedSeq(G__38173__a,0,null);
} 
return G__38171__delegate.call(this,rdr,_);};
G__38171.cljs$lang$maxFixedArity = 1;
G__38171.cljs$lang$applyTo = (function (arglist__38174){
var rdr = cljs.core.first(arglist__38174);
var _ = cljs.core.rest(arglist__38174);
return G__38171__delegate(rdr,_);
});
