...
var G__48332 = placesurfer.clipboard_ui.hemnet.listing.parse_number(v);
if((G__48332 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48332);
}
});
 ...
 */
placesurfer.clipboard_ui.hemnet.form.build_description = (function placesurfer$clipboard_ui$hemnet$form$build_description(p__48333){
var map__48334 = p__48333;
var map__48334__$1 = cljs.core.__destructure_map(map__48334);
var housing_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48334__$1,new cljs.core.Keyword(null,"housing-form","housing-form",-1885695809));
var rooms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48334__$1,new cljs.core.Keyword(null,"rooms","rooms",1196158176));
var living_area = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48334__$1,new cljs.core.Keyword(null,"living-area","living-area",1377243120));
var plot_area = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48334__$1,new cljs.core.Keyword(null,"plot-area","plot-area",98036883));
var asking_price = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48334__$1,new cljs.core.Keyword(null,"asking-price","asking-price",1304329161));
var extra_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48334__$1,new cljs.core.Keyword(null,"extra-values","extra-values",1671557498));
 ...
 */
placesurfer.clipboard_ui.hemnet.form.address_line_for_geocoding = (function placesurfer$clipboard_ui$hemnet$form$address_line_for_geocoding(p__48335){
var map__48336 = p__48335;
var map__48336__$1 = cljs.core.__destructure_map(map__48336);
var street_address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48336__$1,new cljs.core.Keyword(null,"street-address","street-address",1974914551));
var postal_city = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48336__$1,new cljs.core.Keyword(null,"postal-city","postal-city",2130329622));
...
var map__48337 = listing;
var map__48337__$1 = cljs.core.__destructure_map(map__48337);
var extra_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"extra-values","extra-values",1671557498));
var agent_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259));
var housing_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"housing-form","housing-form",-1885695809));
var image_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"image-url","image-url",-1064784064));
var rooms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"rooms","rooms",1196158176));
var asking_price = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"asking-price","asking-price",1304329161));
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var living_area = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"living-area","living-area",1377243120));
var plot_area = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"plot-area","plot-area",98036883));
var postal_city = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"postal-city","postal-city",2130329622));
var street_address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"street-address","street-address",1974914551));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48337__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
