...
var G__52492 = placesurfer.clipboard_ui.hemnet.listing.parse_number(v);
if((G__52492 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52492);
}
});
 ...
 */
placesurfer.clipboard_ui.hemnet.form.build_description = (function placesurfer$clipboard_ui$hemnet$form$build_description(p__52493){
var map__52494 = p__52493;
var map__52494__$1 = cljs.core.__destructure_map(map__52494);
var housing_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52494__$1,new cljs.core.Keyword(null,"housing-form","housing-form",-1885695809));
var rooms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52494__$1,new cljs.core.Keyword(null,"rooms","rooms",1196158176));
var living_area = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52494__$1,new cljs.core.Keyword(null,"living-area","living-area",1377243120));
var plot_area = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52494__$1,new cljs.core.Keyword(null,"plot-area","plot-area",98036883));
var asking_price = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52494__$1,new cljs.core.Keyword(null,"asking-price","asking-price",1304329161));
var extra_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52494__$1,new cljs.core.Keyword(null,"extra-values","extra-values",1671557498));
var plot_label = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52494__$1,new cljs.core.Keyword(null,"plot-label","plot-label",1776911128),"tomt");
 ...
 */
placesurfer.clipboard_ui.hemnet.form.address_line_for_geocoding = (function placesurfer$clipboard_ui$hemnet$form$address_line_for_geocoding(p__52495){
var map__52496 = p__52495;
var map__52496__$1 = cljs.core.__destructure_map(map__52496);
var street_address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52496__$1,new cljs.core.Keyword(null,"street-address","street-address",1974914551));
var postal_city = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52496__$1,new cljs.core.Keyword(null,"postal-city","postal-city",2130329622));
...
var map__52499 = listing;
var map__52499__$1 = cljs.core.__destructure_map(map__52499);
var extra_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"extra-values","extra-values",1671557498));
var agent_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259));
var housing_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"housing-form","housing-form",-1885695809));
var image_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"image-url","image-url",-1064784064));
var rooms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"rooms","rooms",1196158176));
var asking_price = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"asking-price","asking-price",1304329161));
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var living_area = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"living-area","living-area",1377243120));
var plot_area = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"plot-area","plot-area",98036883));
var postal_city = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"postal-city","postal-city",2130329622));
var street_address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"street-address","street-address",1974914551));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52499__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
...
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"description","description",-1428560544),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"longitude","longitude",-1268876372),new cljs.core.Keyword(null,"icon","icon",1679606541),new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"latitude","latitude",394867543),new cljs.core.Keyword(null,"image","image",-58725096),new cljs.core.Keyword(null,"location","location",1815599388),new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259)],[(function (){var or__5025__auto__ = description;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return "";
