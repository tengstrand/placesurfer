...
placesurfer.edit.pure.model.meter_calculation_active_QMARK_ = (function placesurfer$edit$pure$model$meter_calculation_active_QMARK_(p__38999){
var map__39000 = p__38999;
var map__39000__$1 = cljs.core.__destructure_map(map__39000);
var update_sort = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39000__$1,new cljs.core.Keyword(null,"update-sort","update-sort",-1611336622));
var update_show_duplicates_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39000__$1,new cljs.core.Keyword(null,"update-show-duplicates?","update-show-duplicates?",962796900));
...
(placesurfer.edit.pure.model.table_model.cljs$core$IFn$_invoke$arity$2 = (function (state,p__39013){
var map__39015 = p__39013;
var map__39015__$1 = cljs.core.__destructure_map(map__39015);
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39015__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
var map__39016 = state;
var map__39016__$1 = cljs.core.__destructure_map(map__39016);
var update_selected_row_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39016__$1,new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563));
var update_sort = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39016__$1,new cljs.core.Keyword(null,"update-sort","update-sort",-1611336622));
var update_show_duplicates_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39016__$1,new cljs.core.Keyword(null,"update-show-duplicates?","update-show-duplicates?",962796900));
var update_show_invalid_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39016__$1,new cljs.core.Keyword(null,"update-show-invalid?","update-show-invalid?",593477120));
...
var reference_row = (cljs.core.truth_(meter_calc_QMARK_)?(function (){var or__5025__auto__ = (cljs.core.truth_(update_selected_row_id)?cljs.core.some((function (p1__39004_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(update_selected_row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__39004_SHARP_))){
...
var map__39017 = ((duplicate_filter_QMARK_)?(function (){var dup_ids = placesurfer.edit.pure.duplicates.duplicate_row_id_set(all_rows);
var dup_rows = cljs.core.filterv((function (p1__39006_SHARP_){
return cljs.core.contains_QMARK_(dup_ids,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__39006_SHARP_));
}),with_meters);
...
}),with_meters),new cljs.core.Keyword(null,"ui-sort-field","ui-sort-field",690376728),null,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new cljs.core.Keyword(null,"asc","asc",356854569)], null):(function (){var map__39024 = placesurfer.edit.pure.table.resolve_table_sort(update_sort,false);
var map__39024__$1 = cljs.core.__destructure_map(map__39024);
var ui_sort_field = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39024__$1,new cljs.core.Keyword(null,"ui-sort-field","ui-sort-field",690376728));
var sort_field = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39024__$1,new cljs.core.Keyword(null,"sort-field","sort-field",-941433793));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39024__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
...
var visible_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39017__$1,new cljs.core.Keyword(null,"visible-rows","visible-rows",1032226164));
var ui_sort_field = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39017__$1,new cljs.core.Keyword(null,"ui-sort-field","ui-sort-field",690376728));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39017__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
...
var orphan_places = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__39043_SHARP_){
return cljs.core.contains_QMARK_(row_pending_ids,new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__39043_SHARP_));
}),places);
...
var edited = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__39047_SHARP_){
return placesurfer.edit.pure.model.row_unsaved_edited_QMARK_(p1__39047_SHARP_,disk_baseline);
}),rows));
...
var or__5025__auto____$1 = cljs.core.some((function (p1__39048_SHARP_){
return placesurfer.edit.pure.model.row_client_save_pending_QMARK_(p1__39048_SHARP_,disk_baseline);
...
return cljs.core.some((function (p1__39049_SHARP_){
return placesurfer.edit.pure.model.row_client_save_pending_QMARK_(p1__39049_SHARP_,disk_baseline);
