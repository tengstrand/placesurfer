...
placesurfer.edit.pure.model.meter_calculation_active_QMARK_ = (function placesurfer$edit$pure$model$meter_calculation_active_QMARK_(p__58881){
var map__58882 = p__58881;
var map__58882__$1 = cljs.core.__destructure_map(map__58882);
var update_sort = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58882__$1,new cljs.core.Keyword(null,"update-sort","update-sort",-1611336622));
var update_show_duplicates_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58882__$1,new cljs.core.Keyword(null,"update-show-duplicates?","update-show-duplicates?",962796900));
...
(placesurfer.edit.pure.model.table_model.cljs$core$IFn$_invoke$arity$2 = (function (state,p__58887){
var map__58888 = p__58887;
var map__58888__$1 = cljs.core.__destructure_map(map__58888);
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58888__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
var map__58889 = state;
var map__58889__$1 = cljs.core.__destructure_map(map__58889);
var update_selected_row_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58889__$1,new cljs.core.Keyword(null,"update-selected-row-id","update-selected-row-id",-407969563));
var update_sort = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58889__$1,new cljs.core.Keyword(null,"update-sort","update-sort",-1611336622));
var update_show_duplicates_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58889__$1,new cljs.core.Keyword(null,"update-show-duplicates?","update-show-duplicates?",962796900));
var update_show_invalid_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58889__$1,new cljs.core.Keyword(null,"update-show-invalid?","update-show-invalid?",593477120));
...
var invalid_filter_QMARK_ = cljs.core.boolean$(update_show_invalid_QMARK_);
var meter_calc_QMARK_ = placesurfer.edit.pure.model.meter_calculation_active_QMARK_(state);
var reference_row = (cljs.core.truth_(meter_calc_QMARK_)?(function (){var or__5025__auto__ = (cljs.core.truth_(update_selected_row_id)?cljs.core.some((function (p1__58883_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(update_selected_row_id,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__58883_SHARP_))){
return p1__58883_SHARP_;
} else {
return null;
}
}),all_rows):null);
...
var map__58890 = ((duplicate_filter_QMARK_)?(function (){var dup_ids = placesurfer.edit.pure.duplicates.duplicate_row_id_set(all_rows);
var dup_rows = cljs.core.filterv((function (p1__58884_SHARP_){
return cljs.core.contains_QMARK_(dup_ids,new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(p1__58884_SHARP_));
}),with_meters);
...
})():((invalid_filter_QMARK_)?new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"visible-rows","visible-rows",1032226164),cljs.core.filterv((function (row){
return (((!(placesurfer.edit.pure.rows.row_save_fields_valid_QMARK_(row)))) || (((placesurfer.edit.pure.model.form_field_errors_QMARK_(state)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"row-id","row-id",246619473).cljs$core$IFn$_invoke$arity$1(row),update_selected_row_id)))));
}),with_meters),new cljs.core.Keyword(null,"ui-sort-field","ui-sort-field",690376728),null,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757),new cljs.core.Keyword(null,"asc","asc",356854569)], null):(function (){var map__58891 = placesurfer.edit.pure.table.resolve_table_sort(update_sort,false);
var map__58891__$1 = cljs.core.__destructure_map(map__58891);
var ui_sort_field = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58891__$1,new cljs.core.Keyword(null,"ui-sort-field","ui-sort-field",690376728));
var sort_field = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58891__$1,new cljs.core.Keyword(null,"sort-field","sort-field",-941433793));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58891__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
...
var visible_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58890__$1,new cljs.core.Keyword(null,"visible-rows","visible-rows",1032226164));
var ui_sort_field = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58890__$1,new cljs.core.Keyword(null,"ui-sort-field","ui-sort-field",690376728));
var sort_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58890__$1,new cljs.core.Keyword(null,"sort-dir","sort-dir",35994757));
...
var orphan_places = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__58892_SHARP_){
return cljs.core.contains_QMARK_(row_pending_ids,new cljs.core.Keyword(null,"pending-id","pending-id",1999041996).cljs$core$IFn$_invoke$arity$1(p1__58892_SHARP_));
}),places);
...
var edited = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58893_SHARP_){
return placesurfer.edit.pure.model.row_unsaved_edited_QMARK_(p1__58893_SHARP_,disk_baseline);
}),rows));
...
var or__5025__auto____$1 = cljs.core.some((function (p1__58894_SHARP_){
return placesurfer.edit.pure.model.row_client_save_pending_QMARK_(p1__58894_SHARP_,disk_baseline);
...
return cljs.core.some((function (p1__58895_SHARP_){
return placesurfer.edit.pure.model.row_client_save_pending_QMARK_(p1__58895_SHARP_,disk_baseline);
