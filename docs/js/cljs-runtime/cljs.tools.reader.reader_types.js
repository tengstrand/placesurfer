...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_37559 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_37559(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_37565 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_37565(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_37573 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_37573(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_37580 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_37580(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_37581 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_37581(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_37588 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_37588(reader);
}
});
...
var G__37850 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__37851 = s.append(c);
c = G__37850;
s = G__37851;
continue;
}
