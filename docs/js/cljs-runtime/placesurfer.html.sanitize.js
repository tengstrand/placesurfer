goog.provide('placesurfer.html.sanitize');
placesurfer.html.sanitize.allowed_tags = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 11, ["br",null,"img",null,"p",null,"em",null,"ol",null,"a",null,"i",null,"b",null,"ul",null,"strong",null,"li",null], null), null);
placesurfer.html.sanitize.allowed_img_classes = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["description-maps-icon",null,"description-open-icon",null], null), null);
placesurfer.html.sanitize.blocked_with_content = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 7, ["object",null,"form",null,"svg",null,"style",null,"script",null,"iframe",null,"embed",null], null), null);
placesurfer.html.sanitize.br_placeholder = "[[[BR]]]";
placesurfer.html.sanitize.preprocess_br_tags = (function placesurfer$html$sanitize$preprocess_br_tags(s){
return clojure.string.replace(s,/<br\s*\/?>/i,placesurfer.html.sanitize.br_placeholder);
});
placesurfer.html.sanitize.postprocess_br_tags = (function placesurfer$html$sanitize$postprocess_br_tags(s){
return clojure.string.replace(s,placesurfer.html.sanitize.br_placeholder,"<br>");
});
placesurfer.html.sanitize.escape_text = (function placesurfer$html$sanitize$escape_text(s){
...
placesurfer.html.sanitize.text_with_breaks = (function placesurfer$html$sanitize$text_with_breaks(s){
var normalized = clojure.string.replace(s,"\r\n","\n");
var parts = clojure.string.split.cljs$core$IFn$_invoke$arity$3(normalized,/\n/,(-1));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("<br>",cljs.core.map.cljs$core$IFn$_invoke$arity$2(placesurfer.html.sanitize.escape_text,parts));
});
placesurfer.html.sanitize.plain_text_QMARK_ = (function placesurfer$html$sanitize$plain_text_QMARK_(s){
...
placesurfer.html.sanitize.strip_dangerous_blocks = (function placesurfer$html$sanitize$strip_dangerous_blocks(s){
...
}),s,placesurfer.html.sanitize.blocked_with_content);
});
placesurfer.html.sanitize.remove_comments = (function placesurfer$html$sanitize$remove_comments(s){
return clojure.string.replace(s,/<!--.*?-->/s,"");
});
placesurfer.html.sanitize.strip_void_blocked_tags = (function placesurfer$html$sanitize$strip_void_blocked_tags(s){
...
placesurfer.html.sanitize.extract_href = (function placesurfer$html$sanitize$extract_href(attrs){
...
placesurfer.html.sanitize.safe_img_class_QMARK_ = (function placesurfer$html$sanitize$safe_img_class_QMARK_(class_name){
return cljs.core.contains_QMARK_(placesurfer.html.sanitize.allowed_img_classes,clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(class_name)));
});
placesurfer.html.sanitize.strip_event_attrs = (function placesurfer$html$sanitize$strip_event_attrs(attrs){
return clojure.string.replace(cljs.core.str.cljs$core$IFn$_invoke$arity$1(attrs),/\s+on\w+\s*=\s*(\"[^\"]*\"|'[^']*'|[^\s>]+)/i,"");
});
placesurfer.html.sanitize.strip_unsafe_url_attrs = (function placesurfer$html$sanitize$strip_unsafe_url_attrs(attrs){
...
return new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"tag","tag",-1290361223),tag,new cljs.core.Keyword(null,"void","void",-2084626863),((self_close) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("img",tag))),new cljs.core.Keyword(null,"href","href",-793805698),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("a",tag))?placesurfer.html.sanitize.extract_href(attrs):null),new cljs.core.Keyword(null,"src","src",-1651076051),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("img",tag))?placesurfer.html.sanitize.extract_attr(attrs,"src"):null),new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("img",tag))?placesurfer.html.sanitize.extract_attr(attrs,"class"):null),new cljs.core.Keyword(null,"len","len",1423657078),cljs.core.count(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(m,(0)))], null);
} else {
return null;
}
});
...
break;
case 2:
return placesurfer.html.sanitize.parse_nodes.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(placesurfer.html.sanitize.parse_nodes.cljs$core$IFn$_invoke$arity$1 = (function (s){
return placesurfer.html.sanitize.parse_nodes.cljs$core$IFn$_invoke$arity$2(s,null);
}));

(placesurfer.html.sanitize.parse_nodes.cljs$core$IFn$_invoke$arity$2 = (function (s,parent_tag){
var remaining = s;
...
var map__38785 = temp__5823__auto__;
var map__38785__$1 = cljs.core.__destructure_map(map__38785);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38785__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var void$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38785__$1,new cljs.core.Keyword(null,"void","void",-2084626863));
var href = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38785__$1,new cljs.core.Keyword(null,"href","href",-793805698));
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38785__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38785__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var len = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38785__$1,new cljs.core.Keyword(null,"len","len",1423657078));
...
var G__38795 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(rest,after);
var G__38796 = nodes;
remaining = G__38795;
nodes = G__38796;
continue;
...
var G__38803 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(rest,(1));
var G__38804 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(nodes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"content","content",15833224),"<"], null));
remaining = G__38803;
nodes = G__38804;
continue;
}
...
var G__38805 = after;
var G__38806 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(nodes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"content","content",15833224),text], null));
remaining = G__38805;
nodes = G__38806;
continue;
...
placesurfer.html.sanitize.render_node = (function placesurfer$html$sanitize$render_node(p__38786){
var map__38787 = p__38786;
var map__38787__$1 = cljs.core.__destructure_map(map__38787);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38787__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38787__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var href = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38787__$1,new cljs.core.Keyword(null,"href","href",-793805698));
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38787__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38787__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38787__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38787__$1,new cljs.core.Keyword(null,"content","content",15833224));
var G__38788 = type;
...
break;
case "element":
var inner = clojure.string.join.cljs$core$IFn$_invoke$arity$2("",cljs.core.map.cljs$core$IFn$_invoke$arity$2(placesurfer.html.sanitize.render_node,children));
if(cljs.core.truth_((function (){var and__5023__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("a",tag);
if(and__5023__auto__){
return placesurfer.html.sanitize.safe_href_QMARK_(href);
} else {
return and__5023__auto__;
}
})())){
return ["<a href=\"",placesurfer.html.sanitize.escape_text(href),"\" target=\"_blank\" rel=\"noopener noreferrer\">",inner,"</a>"].join('');
} else {
if(cljs.core.truth_((function (){var and__5023__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("img",tag);
if(and__5023__auto__){
var and__5023__auto____$1 = placesurfer.html.sanitize.safe_img_src_QMARK_(src);
if(cljs.core.truth_(and__5023__auto____$1)){
return placesurfer.html.sanitize.safe_img_class_QMARK_(class$);
} else {
...
return ["<img class=\"",placesurfer.html.sanitize.escape_text(class$),"\" src=\"",placesurfer.html.sanitize.escape_text(src),"\" alt=\"\" />"].join('');
} else {
...
if(cljs.core.contains_QMARK_(placesurfer.html.sanitize.allowed_tags,tag)){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38788__$1)].join('')));
...
var map__38789 = placesurfer.html.sanitize.parse_nodes.cljs$core$IFn$_invoke$arity$1(cleaned);
var map__38789__$1 = cljs.core.__destructure_map(map__38789);
var nodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38789__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
 ...
 */
placesurfer.html.sanitize.sanitize_description_html = (function placesurfer$html$sanitize$sanitize_description_html(s){
...
return placesurfer.html.sanitize.postprocess_br_tags(((placesurfer.html.sanitize.plain_text_QMARK_(text))?placesurfer.html.sanitize.text_with_breaks(placesurfer.html.sanitize.preprocess_br_tags(text)):placesurfer.html.sanitize.sanitize_html_content(text)));
}
});

//# sourceMappingURL=placesurfer.html.sanitize.js.map
