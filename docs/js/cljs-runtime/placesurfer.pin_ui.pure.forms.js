...
})()),placesurfer.pin_ui.pure.forms.coerce_text(new cljs.core.Keyword(null,"image","image",-58725096).cljs$core$IFn$_invoke$arity$1(item)),placesurfer.pin_ui.pure.forms.coerce_text(new cljs.core.Keyword(null,"agent-name","agent-name",-916187942).cljs$core$IFn$_invoke$arity$1(item)),placesurfer.pin_ui.pure.forms.coerce_text(new cljs.core.Keyword(null,"address","address",559499426).cljs$core$IFn$_invoke$arity$1(item)),placesurfer.pin_ui.pure.forms.coerce_text(new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259).cljs$core$IFn$_invoke$arity$1(item))]);
} else {
...
})(),(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"agent-name","agent-name",-916187942).cljs$core$IFn$_invoke$arity$1(pin_form);
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return "";
