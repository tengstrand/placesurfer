...
placesurfer.browser_storage.core.save_page_BANG_ = (function placesurfer$browser_storage$core$save_page_BANG_(page){
try{if((!((page == null)))){
return sessionStorage.setItem(placesurfer.browser_storage.core.page_session_key,cljs.core.name(page));
} else {
return null;
}
