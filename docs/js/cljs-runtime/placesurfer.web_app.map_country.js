...
placesurfer.web_app.map_country.select_country_at_point_BANG_ = (function placesurfer$web_app$map_country$select_country_at_point_BANG_(p__63031){
var map__63032 = p__63031;
var map__63032__$1 = cljs.core.__destructure_map(map__63032);
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63032__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63032__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
...
var temp__5825__auto___63041__$1 = placesurfer.map_ui.interface$.map_view_state();
if(cljs.core.truth_(temp__5825__auto___63041__$1)){
var view_63042 = temp__5825__auto___63041__$1;
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(placesurfer.web_app.state._BANG_state,cljs.core.assoc,new cljs.core.Keyword(null,"map-restore-view","map-restore-view",1509489165),view_63042);
} else {
}
...
var temp__5825__auto___63043 = new cljs.core.Keyword(null,"map-restore-view","map-restore-view",1509489165).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.web_app.state._BANG_state));
if(cljs.core.truth_(temp__5825__auto___63043)){
var view_63044 = temp__5825__auto___63043;
...
placesurfer.map_ui.interface$.fly_to_view_BANG_(view_63044);
} else {
}
