goog.provide('hitteri.edit.pure.columns');
hitteri.edit.pure.columns.data_column_label = (function hitteri$edit$pure$columns$data_column_label(k,t){
var G__38812 = k;
...
hitteri.edit.pure.columns.column_label = (function hitteri$edit$pure$columns$column_label(var_args){
var G__38815 = arguments.length;
switch (G__38815) {
case 1:
return hitteri.edit.pure.columns.column_label.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return hitteri.edit.pure.columns.column_label.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(hitteri.edit.pure.columns.column_label.cljs$core$IFn$_invoke$arity$1 = (function (k){
return hitteri.edit.pure.columns.column_label.cljs$core$IFn$_invoke$arity$2(k,null);
}));

(hitteri.edit.pure.columns.column_label.cljs$core$IFn$_invoke$arity$2 = (function (k,t){
var G__38816 = k;
...
default:
if(cljs.core.truth_(t)){
return hitteri.edit.pure.columns.data_column_label(k,t);
} else {
return clojure.string.capitalize(cljs.core.name(k));
}
...
(hitteri.edit.pure.columns.column_label.cljs$lang$maxFixedArity = 2);


//# sourceMappingURL=hitteri.edit.pure.columns.js.map
