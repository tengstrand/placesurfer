...
placesurfer.app_ui.ui.view.view = (function placesurfer$app_ui$ui$view$view(p__51568){
var map__51569 = p__51568;
var map__51569__$1 = cljs.core.__destructure_map(map__51569);
var props = map__51569__$1;
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51569__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
var set_locale_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51569__$1,new cljs.core.Keyword(null,"set-locale!","set-locale!",136598172),(function (_){
return null;
}));
var topic_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51569__$1,new cljs.core.Keyword(null,"topic-rows","topic-rows",1351926944),cljs.core.PersistentVector.EMPTY);
var locale = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51569__$1,new cljs.core.Keyword(null,"locale","locale",-2115712697),new cljs.core.Keyword(null,"en","en",88457073));
var backend_online_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51569__$1,new cljs.core.Keyword(null,"backend-online?","backend-online?",-200708729),false);
var navigate_to_pin_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51569__$1,new cljs.core.Keyword(null,"navigate-to-pin!","navigate-to-pin!",2100011720));
var navigate_to_update_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51569__$1,new cljs.core.Keyword(null,"navigate-to-update!","navigate-to-update!",-1444232757));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51569__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51569__$1,new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"home","home",-74557309));
var country_iso = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51569__$1,new cljs.core.Keyword(null,"country-iso","country-iso",-1029731117));
var app_version = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51569__$1,new cljs.core.Keyword(null,"app-version","app-version",361554836));
