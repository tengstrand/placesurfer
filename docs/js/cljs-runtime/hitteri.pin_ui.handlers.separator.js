goog.provide('hitteri.pin_ui.handlers.separator');
hitteri.pin_ui.handlers.separator.close_overlay = (function hitteri$pin_ui$handlers$separator$close_overlay(s){
...
hitteri.pin_ui.handlers.separator.overlay_snapshot = (function hitteri$pin_ui$handlers$separator$overlay_snapshot(s){
...
hitteri.pin_ui.handlers.separator.restore_overlay_snapshot_BANG_ = (function hitteri$pin_ui$handlers$separator$restore_overlay_snapshot_BANG_(s,snapshot){
...
hitteri.pin_ui.handlers.separator.cancel_pin_editor_if_open_BANG_ = (function hitteri$pin_ui$handlers$separator$cancel_pin_editor_if_open_BANG_(){
...
hitteri.pin_ui.handlers.separator.open_pin_separator_overlay_BANG_ = (function hitteri$pin_ui$handlers$separator$open_pin_separator_overlay_BANG_(){
hitteri.pin_ui.handlers.separator.cancel_pin_editor_if_open_BANG_();

return hitteri.pin_ui.handlers.state.swap_render_BANG_((function (s){
var overlay_rows = hitteri.pin_ui.pure.rows.separator_overlay_rows_from_items(new cljs.core.Keyword(null,"pin-items","pin-items",-1214148100).cljs$core$IFn$_invoke$arity$1(s));
...
hitteri.pin_ui.handlers.separator.cancel_pin_separator_overlay_BANG_ = (function hitteri$pin_ui$handlers$separator$cancel_pin_separator_overlay_BANG_(){
return hitteri.pin_ui.handlers.state.swap_render_BANG_((function (s){
return hitteri.pin_ui.handlers.separator.close_overlay(hitteri.pin_ui.handlers.separator.restore_overlay_snapshot_BANG_(s,new cljs.core.Keyword(null,"pin-separator-overlay-snapshot","pin-separator-overlay-snapshot",-1756599608).cljs$core$IFn$_invoke$arity$2(s,hitteri.pin_ui.handlers.separator.overlay_snapshot(s))));
}));
});
hitteri.pin_ui.handlers.separator.select_separator_overlay_row_BANG_ = (function hitteri$pin_ui$handlers$separator$select_separator_overlay_row_BANG_(id){
return hitteri.pin_ui.handlers.state.swap_render_BANG_((function (p1__49799_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__49799_SHARP_,new cljs.core.Keyword(null,"pin-separator-overlay-selected-id","pin-separator-overlay-selected-id",358246088),id);
}));
});
hitteri.pin_ui.handlers.separator.set_separator_overlay_label_BANG_ = (function hitteri$pin_ui$handlers$separator$set_separator_overlay_label_BANG_(id,label){
return hitteri.pin_ui.handlers.state.swap_render_BANG_((function (s){
...
hitteri.pin_ui.handlers.separator.focus_separator_overlay_input_BANG_ = (function hitteri$pin_ui$handlers$separator$focus_separator_overlay_input_BANG_(id){
...
var seq__49811 = cljs.core.seq(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(60),(140),(260)], null));
var chunk__49812 = null;
var count__49813 = (0);
var i__49814 = (0);
while(true){
if((i__49814 < count__49813)){
var delay_ms = chunk__49812.cljs$core$IIndexed$_nth$arity$2(null,i__49814);
setTimeout(((function (seq__49811,chunk__49812,count__49813,i__49814,delay_ms,element_id){
return (function (){
...
});})(seq__49811,chunk__49812,count__49813,i__49814,delay_ms,element_id))
,delay_ms);


var G__49826 = seq__49811;
var G__49827 = chunk__49812;
var G__49828 = count__49813;
var G__49829 = (i__49814 + (1));
seq__49811 = G__49826;
...
var temp__5825__auto__ = cljs.core.seq(seq__49811);
if(temp__5825__auto__){
var seq__49811__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__49811__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__49811__$1);
var G__49830 = cljs.core.chunk_rest(seq__49811__$1);
var G__49831 = c__5548__auto__;
var G__49832 = cljs.core.count(c__5548__auto__);
var G__49833 = (0);
seq__49811 = G__49830;
chunk__49812 = G__49831;
count__49813 = G__49832;
i__49814 = G__49833;
continue;
} else {
var delay_ms = cljs.core.first(seq__49811__$1);
setTimeout(((function (seq__49811,chunk__49812,count__49813,i__49814,delay_ms,seq__49811__$1,temp__5825__auto__,element_id){
return (function (){
...
});})(seq__49811,chunk__49812,count__49813,i__49814,delay_ms,seq__49811__$1,temp__5825__auto__,element_id))
,delay_ms);


var G__49834 = cljs.core.next(seq__49811__$1);
var G__49835 = null;
var G__49836 = (0);
var G__49837 = (0);
seq__49811 = G__49834;
chunk__49812 = G__49835;
count__49813 = G__49836;
i__49814 = G__49837;
continue;
}
} else {
...
hitteri.pin_ui.handlers.separator.add_separator_overlay_row_BANG_ = (function hitteri$pin_ui$handlers$separator$add_separator_overlay_row_BANG_(){
var id = hitteri.pin_ui.pure.storage.new_pin_id();
...
return hitteri.pin_ui.handlers.separator.focus_separator_overlay_input_BANG_(id);
});
hitteri.pin_ui.handlers.separator.delete_separator_overlay_row_BANG_ = (function hitteri$pin_ui$handlers$separator$delete_separator_overlay_row_BANG_(id){
return hitteri.pin_ui.handlers.state.swap_render_BANG_((function (s){
...
var remaining = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__49822_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__49822_SHARP_));
}),overlay_rows));
...
hitteri.pin_ui.handlers.separator.persist_items_BANG_ = (function hitteri$pin_ui$handlers$separator$persist_items_BANG_(items){
return hitteri.pin_ui.pure.storage.save_pins_BANG_(items);
});
hitteri.pin_ui.handlers.separator.confirm_separator_overlay_BANG_ = (function hitteri$pin_ui$handlers$separator$confirm_separator_overlay_BANG_(){
var saved = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
hitteri.pin_ui.handlers.state.swap_state_BANG_((function (s){
var next_items = hitteri.pin_ui.pure.rows.apply_separator_overlay_edits(new cljs.core.Keyword(null,"pin-items","pin-items",-1214148100).cljs$core$IFn$_invoke$arity$1(s),new cljs.core.Keyword(null,"pin-separator-overlay-rows","pin-separator-overlay-rows",-65364147).cljs$core$IFn$_invoke$arity$2(s,cljs.core.PersistentVector.EMPTY));
cljs.core.reset_BANG_(saved,next_items);

return hitteri.pin_ui.handlers.rows.refresh_table_rows.cljs$core$IFn$_invoke$arity$1(hitteri.pin_ui.handlers.separator.close_overlay(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.Keyword(null,"pin-items","pin-items",-1214148100),next_items)));
}));

if(cljs.core.truth_(cljs.core.deref(saved))){
hitteri.pin_ui.handlers.separator.persist_items_BANG_(cljs.core.deref(saved));
...
//# sourceMappingURL=hitteri.pin_ui.handlers.separator.js.map
