goog.provide('hitteri.load.gis');
hitteri.load.gis.countries_url = "data/world-countries.edn";
hitteri.load.gis.ensure_position_description = (function hitteri$load$gis$ensure_position_description(position){
...
hitteri.load.gis.ensure_position_image = (function hitteri$load$gis$ensure_position_image(position){
...
hitteri.load.gis.parse_edn = (function hitteri$load$gis$parse_edn(text){
...
return hitteri.load.gis.ensure_position_description(hitteri.load.gis.ensure_position_image(position));
...
hitteri.load.gis.fetch_text_BANG_ = (function hitteri$load$gis$fetch_text_BANG_(url){
...
hitteri.load.gis.merge_country_counts = (function hitteri$load$gis$merge_country_counts(countries,counts_by_slug){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__38720_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__38720_SHARP_,new cljs.core.Keyword(null,"count","count",2139924085),cljs.core.get.cljs$core$IFn$_invoke$arity$3(counts_by_slug,new cljs.core.Keyword(null,"slug","slug",2029314850).cljs$core$IFn$_invoke$arity$1(p1__38720_SHARP_),(0)));
}),countries);
});
hitteri.load.gis.load_counts_BANG_ = (function hitteri$load$gis$load_counts_BANG_(counts_url){
return hitteri.load.gis.fetch_text_BANG_(counts_url).then((function (p1__38721_SHARP_){
return Promise.resolve(cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__38721_SHARP_));
})).catch((function (_){
return Promise.resolve(cljs.core.PersistentArrayMap.EMPTY);
}));
});
hitteri.load.gis.load_countries_BANG_ = (function hitteri$load$gis$load_countries_BANG_(counts_url){
return Promise.all(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hitteri.load.gis.fetch_text_BANG_(hitteri.load.gis.countries_url),hitteri.load.gis.load_counts_BANG_(counts_url)], null)).then((function (p__38722){
var vec__38724 = p__38722;
...
return Promise.resolve(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"label","label",1718410804),hitteri.load.gis.merge_country_counts(countries,counts)));
}));
});
hitteri.load.gis.load_country_BANG_ = (function hitteri$load$gis$load_country_BANG_(gis_url_fn,slug){
...
if(cljs.core.truth_(resp.ok)){
return resp.text().then(hitteri.load.gis.parse_edn);
} else {
...
//# sourceMappingURL=hitteri.load.gis.js.map
