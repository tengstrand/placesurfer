...
placesurfer.app_ui.ui.view_props.nav_handler_props = (function placesurfer$app_ui$ui$view_props$nav_handler_props(p__40972){
var map__40974 = p__40972;
var map__40974__$1 = cljs.core.__destructure_map(map__40974);
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40974__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var select_country_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40974__$1,new cljs.core.Keyword(null,"select-country!","select-country!",-1237350741));
var set_country_filter_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40974__$1,new cljs.core.Keyword(null,"set-country-filter!","set-country-filter!",-1983545420));
var set_country_highlight_index_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40974__$1,new cljs.core.Keyword(null,"set-country-highlight-index!","set-country-highlight-index!",1161345176));
var set_topic_active_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40974__$1,new cljs.core.Keyword(null,"set-topic-active!","set-topic-active!",254957295));
var ensure_countries_loaded_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40974__$1,new cljs.core.Keyword(null,"ensure-countries-loaded!","ensure-countries-loaded!",1392756926));
var show_map_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40974__$1,new cljs.core.Keyword(null,"show-map!","show-map!",-168806063));
...
placesurfer.app_ui.ui.view_props.view_props = (function placesurfer$app_ui$ui$view_props$view_props(state,p__40990){
var map__40993 = p__40990;
var map__40993__$1 = cljs.core.__destructure_map(map__40993);
var topic_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40993__$1,new cljs.core.Keyword(null,"topic-keys","topic-keys",1815833268));
var topic_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40993__$1,new cljs.core.Keyword(null,"topic-label-fn","topic-label-fn",-15666023));
var topic_marker_url_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40993__$1,new cljs.core.Keyword(null,"topic-marker-url-fn","topic-marker-url-fn",-1547313478));
var mobile_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40993__$1,new cljs.core.Keyword(null,"mobile?","mobile?",1358664528));
var handlers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40993__$1,new cljs.core.Keyword(null,"handlers","handlers",79528781));
var map_handler_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40993__$1,new cljs.core.Keyword(null,"map-handler-props","map-handler-props",1190365928));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40993__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
