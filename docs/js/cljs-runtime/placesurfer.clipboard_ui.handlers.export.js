...
var groups = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__41351_SHARP_){
return cljs.core.select_keys(p1__41351_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804)], null));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__41352_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"separator","separator",-1628749125),new cljs.core.Keyword(null,"kind","kind",-717265803).cljs$core$IFn$_invoke$arity$1(p1__41352_SHARP_));
}),items));
var pins = cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__41353,item){
var vec__41354 = p__41353;
var acc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41354,(0),null);
var current_label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41354,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,(function (){var G__41357 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(item,new cljs.core.Keyword(null,"id","id",-1388402092));
if(cljs.core.truth_(current_label)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41357,new cljs.core.Keyword(null,"group","group",582596132),current_label);
} else {
return G__41357;
}
})()),current_label], null);
