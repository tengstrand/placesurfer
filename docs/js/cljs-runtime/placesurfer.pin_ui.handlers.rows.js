...
if(cljs.core.truth_(cljs.core.some((function (p1__56405_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(include_id_STAR_,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__56405_SHARP_));
}),filtered))){
return filtered;
} else {
...
var seq__56416 = cljs.core.seq(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(60),(140),(260)], null));
var chunk__56417 = null;
var count__56418 = (0);
var i__56419 = (0);
while(true){
if((i__56419 < count__56418)){
var delay_ms = chunk__56417.cljs$core$IIndexed$_nth$arity$2(null,i__56419);
setTimeout(((function (seq__56416,chunk__56417,count__56418,i__56419,delay_ms){
return (function (){
...
});})(seq__56416,chunk__56417,count__56418,i__56419,delay_ms))
,delay_ms);


var G__56462 = seq__56416;
var G__56463 = chunk__56417;
var G__56464 = count__56418;
var G__56465 = (i__56419 + (1));
seq__56416 = G__56462;
chunk__56417 = G__56463;
count__56418 = G__56464;
i__56419 = G__56465;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__56416);
if(temp__5825__auto__){
var seq__56416__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__56416__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__56416__$1);
var G__56466 = cljs.core.chunk_rest(seq__56416__$1);
var G__56467 = c__5548__auto__;
var G__56468 = cljs.core.count(c__5548__auto__);
var G__56469 = (0);
seq__56416 = G__56466;
chunk__56417 = G__56467;
count__56418 = G__56468;
i__56419 = G__56469;
continue;
} else {
var delay_ms = cljs.core.first(seq__56416__$1);
setTimeout(((function (seq__56416,chunk__56417,count__56418,i__56419,delay_ms,seq__56416__$1,temp__5825__auto__){
return (function (){
...
});})(seq__56416,chunk__56417,count__56418,i__56419,delay_ms,seq__56416__$1,temp__5825__auto__))
,delay_ms);


var G__56470 = cljs.core.next(seq__56416__$1);
var G__56471 = null;
var G__56472 = (0);
var G__56473 = (0);
seq__56416 = G__56470;
chunk__56417 = G__56471;
count__56418 = G__56472;
i__56419 = G__56473;
continue;
}
} else {
...
return placesurfer.pin_ui.handlers.rows.refresh_table_rows.cljs$core$IFn$_invoke$arity$2(placesurfer.pin_ui.handlers.state.clear_search_ui((function (){var G__56426 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(s,new cljs.core.Keyword(null,"pin-items","pin-items",-1214148100),next_items,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"pin-form","pin-form",1370425130),form,new cljs.core.Keyword(null,"pin-form-baseline","pin-form-baseline",552218539),form,new cljs.core.Keyword(null,"pin-selected-id","pin-selected-id",261877228),item_id,new cljs.core.Keyword(null,"pin-message","pin-message",-1508485154),null], 0));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56426,new cljs.core.Keyword(null,"pin-new-draft-id","pin-new-draft-id",1457124075),null);
} else {
return G__56426;
}
})()),item_id);
...
(placesurfer.pin_ui.handlers.rows.save_pin_BANG_.cljs$core$IFn$_invoke$arity$1 = (function (p__56429){
var map__56430 = p__56429;
var map__56430__$1 = cljs.core.__destructure_map(map__56430);
var focus_map_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56430__$1,new cljs.core.Keyword(null,"focus-map?","focus-map?",1367256164),true);
...
(placesurfer.pin_ui.handlers.rows.add_pin_BANG_.cljs$core$IFn$_invoke$arity$1 = (function (p__56433){
var map__56434 = p__56433;
var map__56434__$1 = cljs.core.__destructure_map(map__56434);
var force_new_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56434__$1,new cljs.core.Keyword(null,"force-new?","force-new?",-15330180));
var saved = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
var saved_id = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
...
var item = (function (){var G__56435 = base;
if(cljs.core.truth_(existing)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56435,new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(existing));
} else {
return G__56435;
}
})();
...
var temp__5825__auto___56480 = placesurfer.pin_ui.pure.rows.find_by_id(cljs.core.deref(saved),cljs.core.deref(saved_id));
if(cljs.core.truth_(temp__5825__auto___56480)){
var item_56481 = temp__5825__auto___56480;
placesurfer.pin_ui.handlers.map.focus_pin_on_map_BANG_(item_56481);
} else {
}
...
var G__56438 = s;
var G__56438__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56438,new cljs.core.Keyword(null,"pin-items","pin-items",-1214148100),next_items)
;
var G__56438__$2 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"pin-selected-id","pin-selected-id",261877228).cljs$core$IFn$_invoke$arity$1(s)))?cljs.core.update.cljs$core$IFn$_invoke$arity$variadic(G__56438__$1,new cljs.core.Keyword(null,"pin-form","pin-form",1370425130),cljs.core.assoc,new cljs.core.Keyword(null,"name","name",1843675177),name,new cljs.core.Keyword(null,"location","location",1815599388),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([address], 0)):G__56438__$1);
return placesurfer.pin_ui.handlers.rows.refresh_table_rows.cljs$core$IFn$_invoke$arity$2(G__56438__$2,id);
...
if((total > (0))){
var parts = (function (){var G__56439 = cljs.core.PersistentVector.EMPTY;
var G__56439__$1 = (((no_coords > (0)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__56439,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(no_coords),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),no_coords))?" entry":" entries")," without coordinates"].join('')):G__56439);
if((no_name > (0))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__56439__$1,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(no_name),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),no_name))?" entry":" entries")," without name"].join(''));
} else {
return G__56439__$1;
}
})();
 ...
 */
placesurfer.pin_ui.handlers.rows.import_pin_items_BANG_ = (function placesurfer$pin_ui$handlers$rows$import_pin_items_BANG_(p__56443){
var map__56444 = p__56443;
var map__56444__$1 = cljs.core.__destructure_map(map__56444);
var pins = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56444__$1,new cljs.core.Keyword(null,"pins","pins",1725193285));
var groups = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56444__$1,new cljs.core.Keyword(null,"groups","groups",-136896102));
var pins__$1 = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__56440_SHARP_){
return clojure.set.rename_keys(p1__56440_SHARP_,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"location","location",1815599388),new cljs.core.Keyword(null,"address","address",559499426)], null));
...
var map__56445 = (function (){var rem = cljs.core.seq(current);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ungrouped","ungrouped",-339184006),ung,new cljs.core.Keyword(null,"sections","sections",-886710106),(function (){var G__56448 = secs;
if(cljs.core.truth_(cur_sep)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__56448,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"separator","separator",-1628749125),cur_sep,new cljs.core.Keyword(null,"pins","pins",1725193285),cur_pins], null));
} else {
return G__56448;
}
})()], null);
...
var G__56483 = cljs.core.rest(rem);
var G__56484 = ung;
var G__56485 = (function (){var G__56449 = secs;
if(cljs.core.truth_(cur_sep)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__56449,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"separator","separator",-1628749125),cur_sep,new cljs.core.Keyword(null,"pins","pins",1725193285),cur_pins], null));
} else {
return G__56449;
}
})();
var G__56486 = item;
var G__56487 = cljs.core.PersistentVector.EMPTY;
rem = G__56483;
ung = G__56484;
secs = G__56485;
cur_sep = G__56486;
...
if(cljs.core.truth_(cur_sep)){
var G__56489 = cljs.core.rest(rem);
var G__56490 = ung;
var G__56491 = secs;
var G__56492 = cur_sep;
var G__56493 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cur_pins,item);
rem = G__56489;
ung = G__56490;
secs = G__56491;
cur_sep = G__56492;
...
var G__56494 = cljs.core.rest(rem);
var G__56495 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ung,item);
var G__56496 = secs;
var G__56497 = null;
...
var ungrouped = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56445__$1,new cljs.core.Keyword(null,"ungrouped","ungrouped",-339184006));
var sections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56445__$1,new cljs.core.Keyword(null,"sections","sections",-886710106));
var existing_sep_labels = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentHashSet.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__56441_SHARP_){
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"separator","separator",-1628749125).cljs$core$IFn$_invoke$arity$1(p1__56441_SHARP_),"")).toLowerCase();
})),sections);
var existing_coords = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__56442_SHARP_){
if(((typeof new cljs.core.Keyword(null,"longitude","longitude",-1268876372).cljs$core$IFn$_invoke$arity$1(p1__56442_SHARP_) === 'number') && (typeof new cljs.core.Keyword(null,"latitude","latitude",394867543).cljs$core$IFn$_invoke$arity$1(p1__56442_SHARP_) === 'number'))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"longitude","longitude",-1268876372).cljs$core$IFn$_invoke$arity$1(p1__56442_SHARP_),new cljs.core.Keyword(null,"latitude","latitude",394867543).cljs$core$IFn$_invoke$arity$1(p1__56442_SHARP_)], null);
} else {
return null;
}
...
if(cljs.core.truth_((function (){var G__56451 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lon,lat], null);
var fexpr__56450 = cljs.core.deref(seen_coords);
return (fexpr__56450.cljs$core$IFn$_invoke$arity$1 ? fexpr__56450.cljs$core$IFn$_invoke$arity$1(G__56451) : fexpr__56450.call(null,G__56451));
})())){
return null;
} else {
...
var updated_sections = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__56452){
var map__56453 = p__56452;
var map__56453__$1 = cljs.core.__destructure_map(map__56453);
var separator = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56453__$1,new cljs.core.Keyword(null,"separator","separator",-1628749125));
var pins__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56453__$1,new cljs.core.Keyword(null,"pins","pins",1725193285));
...
var new_sections = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__56454){
var map__56455 = p__56454;
var map__56455__$1 = cljs.core.__destructure_map(map__56455);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56455__$1,new cljs.core.Keyword(null,"label","label",1718410804));
...
var next_items = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(ungrouped),cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new_ungrouped,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__56456){
var map__56457 = p__56456;
var map__56457__$1 = cljs.core.__destructure_map(map__56457);
var separator = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56457__$1,new cljs.core.Keyword(null,"separator","separator",-1628749125));
var pins__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56457__$1,new cljs.core.Keyword(null,"pins","pins",1725193285));
...
return placesurfer.pin_ui.handlers.rows.refresh_table_rows.cljs$core$IFn$_invoke$arity$2(placesurfer.pin_ui.handlers.state.clear_search_ui((function (){var G__56458 = (function (){var G__56459 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.Keyword(null,"pin-items","pin-items",-1214148100),next_items);
if(cljs.core.truth_(cljs.core.deref(first_new_id))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56459,new cljs.core.Keyword(null,"pin-selected-id","pin-selected-id",261877228),cljs.core.deref(first_new_id));
} else {
return G__56459;
}
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56458,new cljs.core.Keyword(null,"pin-message","pin-message",-1508485154),msg);
} else {
return G__56458;
}
...
var temp__5825__auto___56502 = cljs.core.deref(first_new_id);
if(cljs.core.truth_(temp__5825__auto___56502)){
var fid_56503 = temp__5825__auto___56502;
var temp__5825__auto___56505__$1 = placesurfer.pin_ui.pure.rows.find_by_id(cljs.core.deref(saved),fid_56503);
if(cljs.core.truth_(temp__5825__auto___56505__$1)){
var item_56507 = temp__5825__auto___56505__$1;
placesurfer.pin_ui.handlers.map.focus_pin_on_map_BANG_(item_56507);
} else {
}
} else {
}
...
return cljs.core.some((function (p1__56460_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__56460_SHARP_));
