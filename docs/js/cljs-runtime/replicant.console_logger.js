...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__41498_SHARP_){
return new cljs.core.Keyword("replicant","internal","replicant/internal",-1504696787).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(cljs.core.val(p1__41498_SHARP_)));
}),x));
} else {
return x;
}
...
replicant.console_logger.report = (function replicant$console_logger$report(p__41499){
var map__41500 = p__41499;
var map__41500__$1 = cljs.core.__destructure_map(map__41500);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41500__$1,new cljs.core.Keyword(null,"title","title",636505583));
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41500__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41500__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
var fname = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41500__$1,new cljs.core.Keyword(null,"fname","fname",1500291491));
var alias = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41500__$1,new cljs.core.Keyword(null,"alias","alias",-2039751630));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41500__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
var formatted_41509 = replicant.console_logger.pprstr(data);
if((((formatted_41509).length) < (80))){
replicant.console_logger.log(["Input data: ",formatted_41509].join(''));
} else {
replicant.console_logger.log("Input data:");

replicant.console_logger.log(formatted_41509);
}
} else {
}
