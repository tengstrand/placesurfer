...
var G__47177 = cljs.core.PersistentArrayMap.EMPTY;
var G__47177__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47177,new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item)):G__47177);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47181__$1,new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259),new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259).cljs$core$IFn$_invoke$arity$1(item));
} else {
return G__47181__$1;
}
});
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47187__$1,new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259),new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259).cljs$core$IFn$_invoke$arity$1(form));
} else {
return G__47187__$1;
}
} else {
...
var G__47197 = new cljs.core.Keyword(null,"pin-editor-mode","pin-editor-mode",-577269186).cljs$core$IFn$_invoke$arity$1(s);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__47195_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__47195_SHARP_));
}),saved)),overlay);
} else {
return saved;
}
...
break;
default:
if(cljs.core.truth_(cljs.core.some((function (p1__47196_SHARP_){
return placesurfer.pin_ui.handlers.map.coords_match_QMARK_(draft,p1__47196_SHARP_);
}),saved))){
return saved;
} else {
...
if(cljs.core.truth_(temp__5825__auto__)){
var id = temp__5825__auto__;
return cljs.core.some((function (p1__47202_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__47202_SHARP_));
}),positions);
} else {
return null;
}
...
var G__47219 = position;
var G__47219__$1 = (cljs.core.truth_(lon)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47219,new cljs.core.Keyword(null,"longitude","longitude",-1268876372),lon):G__47219);
if(cljs.core.truth_(lat)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47219__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543),lat);
} else {
return G__47219__$1;
}
});
placesurfer.pin_ui.handlers.map.main_map_pin_positions = (function placesurfer$pin_ui$handlers$map$main_map_pin_positions(s){
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47225_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pin","pin",-2111774834),new cljs.core.Keyword(null,"marker-topic","marker-topic",652240154).cljs$core$IFn$_invoke$arity$1(p1__47225_SHARP_));
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47233_SHARP_){
return placesurfer.pin_ui.handlers.map.position_matches_click_QMARK_(click,p1__47233_SHARP_);
...
(placesurfer.pin_ui.handlers.map.sync_pin_map_BANG_.cljs$core$IFn$_invoke$arity$1 = (function (p__47243){
var map__47244 = p__47243;
var map__47244__$1 = cljs.core.__destructure_map(map__47244);
var recenter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47244__$1,new cljs.core.Keyword(null,"recenter?","recenter?",-1643219315),true);
var open_popup_for = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47244__$1,new cljs.core.Keyword(null,"open-popup-for","open-popup-for",1279326185));
...
var len__5749__auto___47400 = arguments.length;
var i__5750__auto___47401 = (0);
while(true){
if((i__5750__auto___47401 < len__5749__auto___47400)){
args__5755__auto__.push((arguments[i__5750__auto___47401]));

var G__47402 = (i__5750__auto___47401 + (1));
i__5750__auto___47401 = G__47402;
continue;
} else {
}
break;
...
(placesurfer.pin_ui.handlers.map.schedule_pin_map_sync_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (p__47256){
var vec__47257 = p__47256;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47257,(0),null);
...
/** @this {Function} */
(placesurfer.pin_ui.handlers.map.schedule_pin_map_sync_BANG_.cljs$lang$applyTo = (function (seq47246){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47246));
}));
...
var args__5755__auto__ = [];
var len__5749__auto___47405 = arguments.length;
var i__5750__auto___47406 = (0);
while(true){
if((i__5750__auto___47406 < len__5749__auto___47405)){
args__5755__auto__.push((arguments[i__5750__auto___47406]));

var G__47411 = (i__5750__auto___47406 + (1));
i__5750__auto___47406 = G__47411;
continue;
} else {
}
break;
...
(placesurfer.pin_ui.handlers.map.schedule_pin_popup_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (match,p__47284){
var vec__47285 = p__47284;
var map__47288 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47285,(0),null);
var map__47288__$1 = cljs.core.__destructure_map(map__47288);
var attempt = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47288__$1,new cljs.core.Keyword(null,"attempt","attempt",1611761308),(0));
var delay_ms = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47288__$1,new cljs.core.Keyword(null,"delay-ms","delay-ms",-59253516),(150));
if((attempt <= (8))){
...
/** @this {Function} */
(placesurfer.pin_ui.handlers.map.schedule_pin_popup_BANG_.cljs$lang$applyTo = (function (seq47272){
var G__47273 = cljs.core.first(seq47272);
var seq47272__$1 = cljs.core.next(seq47272);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47273,seq47272__$1);
}));
...
if(cljs.core.truth_(temp__5825__auto__)){
var id = temp__5825__auto__;
return cljs.core.some((function (p1__47299_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__47299_SHARP_))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pin","pin",-2111774834),new cljs.core.Keyword(null,"marker-topic","marker-topic",652240154).cljs$core$IFn$_invoke$arity$1(p1__47299_SHARP_))));
}),placesurfer.pin_ui.handlers.map.main_map_positions(s));
} else {
return null;
}
...
var args__5755__auto__ = [];
var len__5749__auto___47428 = arguments.length;
var i__5750__auto___47430 = (0);
while(true){
if((i__5750__auto___47430 < len__5749__auto___47428)){
args__5755__auto__.push((arguments[i__5750__auto___47430]));

var G__47431 = (i__5750__auto___47430 + (1));
i__5750__auto___47430 = G__47431;
continue;
} else {
}
break;
...
(placesurfer.pin_ui.handlers.map.focus_pin_on_map_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (item,p__47346){
var vec__47347 = p__47346;
var map__47350 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47347,(0),null);
var map__47350__$1 = cljs.core.__destructure_map(map__47350);
var open_popup_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47350__$1,new cljs.core.Keyword(null,"open-popup?","open-popup?",-511246520));
...
var match = placesurfer.pin_ui.handlers.map.pin_popup_match(item);
placesurfer.pin_ui.handlers.map.sync_map_for_current_page_BANG_((function (){var G__47351 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"recenter?","recenter?",-1643219315),false], null);
if(open_popup_QMARK__STAR_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47351,new cljs.core.Keyword(null,"open-popup-for","open-popup-for",1279326185),match);
} else {
return G__47351;
}
})());
...
/** @this {Function} */
(placesurfer.pin_ui.handlers.map.focus_pin_on_map_BANG_.cljs$lang$applyTo = (function (seq47337){
...
var args__5755__auto__ = [];
var len__5749__auto___47433 = arguments.length;
var i__5750__auto___47434 = (0);
while(true){
if((i__5750__auto___47434 < len__5749__auto___47433)){
args__5755__auto__.push((arguments[i__5750__auto___47434]));

var G__47435 = (i__5750__auto___47434 + (1));
i__5750__auto___47434 = G__47435;
continue;
} else {
}
break;
...
(placesurfer.pin_ui.handlers.map.schedule_center_on_pin_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (position,p__47357){
var vec__47359 = p__47357;
var map__47362 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47359,(0),null);
var map__47362__$1 = cljs.core.__destructure_map(map__47362);
var delay_ms = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__47362__$1,new cljs.core.Keyword(null,"delay-ms","delay-ms",-59253516),(80));
...
/** @this {Function} */
(placesurfer.pin_ui.handlers.map.schedule_center_on_pin_BANG_.cljs$lang$applyTo = (function (seq47352){
var G__47353 = cljs.core.first(seq47352);
var seq47352__$1 = cljs.core.next(seq47352);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47353,seq47352__$1);
}));
