...
var G__39496 = cljs.core.PersistentArrayMap.EMPTY;
var G__39496__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39496,new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item)):G__39496);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39497__$1,new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259),new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259).cljs$core$IFn$_invoke$arity$1(item));
} else {
return G__39497__$1;
}
});
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39511__$1,new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259),new cljs.core.Keyword(null,"agent-url","agent-url",-1202660259).cljs$core$IFn$_invoke$arity$1(form));
} else {
return G__39511__$1;
}
} else {
...
var G__39548 = new cljs.core.Keyword(null,"pin-editor-mode","pin-editor-mode",-577269186).cljs$core$IFn$_invoke$arity$1(s);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__39546_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__39546_SHARP_));
}),saved)),overlay);
} else {
return saved;
}
...
break;
default:
if(cljs.core.truth_(cljs.core.some((function (p1__39547_SHARP_){
return placesurfer.pin_ui.handlers.map.coords_match_QMARK_(draft,p1__39547_SHARP_);
}),saved))){
return saved;
} else {
...
if(cljs.core.truth_(temp__5825__auto__)){
var id = temp__5825__auto__;
return cljs.core.some((function (p1__39577_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__39577_SHARP_));
}),positions);
} else {
return null;
}
...
var G__39580 = position;
var G__39580__$1 = (cljs.core.truth_(lon)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39580,new cljs.core.Keyword(null,"longitude","longitude",-1268876372),lon):G__39580);
if(cljs.core.truth_(lat)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39580__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543),lat);
} else {
return G__39580__$1;
}
});
placesurfer.pin_ui.handlers.map.main_map_pin_positions = (function placesurfer$pin_ui$handlers$map$main_map_pin_positions(s){
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__39582_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pin","pin",-2111774834),new cljs.core.Keyword(null,"marker-topic","marker-topic",652240154).cljs$core$IFn$_invoke$arity$1(p1__39582_SHARP_));
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__39583_SHARP_){
return placesurfer.pin_ui.handlers.map.position_matches_click_QMARK_(click,p1__39583_SHARP_);
...
(placesurfer.pin_ui.handlers.map.sync_pin_map_BANG_.cljs$core$IFn$_invoke$arity$1 = (function (p__39596){
var map__39597 = p__39596;
var map__39597__$1 = cljs.core.__destructure_map(map__39597);
var recenter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__39597__$1,new cljs.core.Keyword(null,"recenter?","recenter?",-1643219315),true);
var open_popup_for = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39597__$1,new cljs.core.Keyword(null,"open-popup-for","open-popup-for",1279326185));
...
(placesurfer.pin_ui.handlers.map.schedule_pin_map_sync_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (p__39602){
var vec__39603 = p__39602;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39603,(0),null);
...
/** @this {Function} */
(placesurfer.pin_ui.handlers.map.schedule_pin_map_sync_BANG_.cljs$lang$applyTo = (function (seq39601){
var self__5735__auto__ = this;
return self__5735__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq39601));
}));
...
var args__5755__auto__ = [];
var len__5749__auto___39714 = arguments.length;
var i__5750__auto___39715 = (0);
while(true){
if((i__5750__auto___39715 < len__5749__auto___39714)){
args__5755__auto__.push((arguments[i__5750__auto___39715]));

var G__39716 = (i__5750__auto___39715 + (1));
i__5750__auto___39715 = G__39716;
continue;
} else {
}
break;
...
(placesurfer.pin_ui.handlers.map.schedule_pin_popup_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (match,p__39623){
var vec__39624 = p__39623;
var map__39627 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39624,(0),null);
var map__39627__$1 = cljs.core.__destructure_map(map__39627);
var attempt = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__39627__$1,new cljs.core.Keyword(null,"attempt","attempt",1611761308),(0));
var delay_ms = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__39627__$1,new cljs.core.Keyword(null,"delay-ms","delay-ms",-59253516),(150));
if((attempt <= (8))){
...
/** @this {Function} */
(placesurfer.pin_ui.handlers.map.schedule_pin_popup_BANG_.cljs$lang$applyTo = (function (seq39619){
var G__39620 = cljs.core.first(seq39619);
var seq39619__$1 = cljs.core.next(seq39619);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39620,seq39619__$1);
}));
...
if(cljs.core.truth_(temp__5825__auto__)){
var id = temp__5825__auto__;
return cljs.core.some((function (p1__39650_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__39650_SHARP_))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pin","pin",-2111774834),new cljs.core.Keyword(null,"marker-topic","marker-topic",652240154).cljs$core$IFn$_invoke$arity$1(p1__39650_SHARP_))));
}),placesurfer.pin_ui.handlers.map.main_map_positions(s));
} else {
return null;
}
...
var args__5755__auto__ = [];
var len__5749__auto___39719 = arguments.length;
var i__5750__auto___39720 = (0);
while(true){
if((i__5750__auto___39720 < len__5749__auto___39719)){
args__5755__auto__.push((arguments[i__5750__auto___39720]));

var G__39721 = (i__5750__auto___39720 + (1));
i__5750__auto___39720 = G__39721;
continue;
} else {
}
break;
...
(placesurfer.pin_ui.handlers.map.focus_pin_on_map_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (item,p__39668){
var vec__39669 = p__39668;
var map__39672 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39669,(0),null);
var map__39672__$1 = cljs.core.__destructure_map(map__39672);
var open_popup_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39672__$1,new cljs.core.Keyword(null,"open-popup?","open-popup?",-511246520));
...
var match = placesurfer.pin_ui.handlers.map.pin_popup_match(item);
placesurfer.pin_ui.handlers.map.sync_map_for_current_page_BANG_((function (){var G__39673 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"recenter?","recenter?",-1643219315),false], null);
if(open_popup_QMARK__STAR_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39673,new cljs.core.Keyword(null,"open-popup-for","open-popup-for",1279326185),match);
} else {
return G__39673;
}
})());
...
/** @this {Function} */
(placesurfer.pin_ui.handlers.map.focus_pin_on_map_BANG_.cljs$lang$applyTo = (function (seq39665){
var G__39666 = cljs.core.first(seq39665);
var seq39665__$1 = cljs.core.next(seq39665);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39666,seq39665__$1);
}));
...
var args__5755__auto__ = [];
var len__5749__auto___39723 = arguments.length;
var i__5750__auto___39724 = (0);
while(true){
if((i__5750__auto___39724 < len__5749__auto___39723)){
args__5755__auto__.push((arguments[i__5750__auto___39724]));

var G__39725 = (i__5750__auto___39724 + (1));
i__5750__auto___39724 = G__39725;
continue;
} else {
}
break;
...
(placesurfer.pin_ui.handlers.map.schedule_center_on_pin_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (position,p__39688){
var vec__39689 = p__39688;
var map__39692 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39689,(0),null);
var map__39692__$1 = cljs.core.__destructure_map(map__39692);
var delay_ms = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__39692__$1,new cljs.core.Keyword(null,"delay-ms","delay-ms",-59253516),(80));
...
/** @this {Function} */
(placesurfer.pin_ui.handlers.map.schedule_center_on_pin_BANG_.cljs$lang$applyTo = (function (seq39678){
