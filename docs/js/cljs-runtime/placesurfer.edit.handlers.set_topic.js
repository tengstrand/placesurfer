...
var G__39943 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(placesurfer.app_ui.interface$.state.clear_update_selection_state(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.Keyword(null,"update-topic","update-topic",-406732688),topic),new cljs.core.Keyword(null,"pin-editor-open?","pin-editor-open?",1076821159),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"pin-editor-snapshot","pin-editor-snapshot",-352879376)], 0)),new cljs.core.Keyword(null,"pin-editor-inline?","pin-editor-inline?",766617935),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"pin-editor-mode","pin-editor-mode",-577269186),null,new cljs.core.Keyword(null,"pin-show-search?","pin-show-search?",-437021687),false], 0))),new cljs.core.Keyword(null,"pin-form","pin-form",1370425130),placesurfer.pin_ui.interface$.forms.default_form(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"pin-form-baseline","pin-form-baseline",552218539),placesurfer.pin_ui.interface$.forms.default_form(),new cljs.core.Keyword(null,"pin-selected-id","pin-selected-id",261877228),null], 0));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39943,new cljs.core.Keyword(null,"update-topic-before-pins","update-topic-before-pins",998758751),from_topic);
} else {
return G__39943;
}
}));
