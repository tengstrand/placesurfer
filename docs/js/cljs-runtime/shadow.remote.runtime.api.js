...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30884 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30884(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30891 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30891(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30911 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30911(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30918 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30918(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30935 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30935(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30939 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30939(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30870,callback){
var map__30872 = p__30870;
var map__30872__$1 = cljs.core.__destructure_map(map__30872);
var input = map__30872__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30872__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30872__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
