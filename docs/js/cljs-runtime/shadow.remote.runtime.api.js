...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30930 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30930(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30940 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30940(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30952 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30952(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30980 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30980(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31007 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_31007(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31027 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_31027(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30904,callback){
var map__30906 = p__30904;
var map__30906__$1 = cljs.core.__destructure_map(map__30906);
var input = map__30906__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30906__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30906__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
