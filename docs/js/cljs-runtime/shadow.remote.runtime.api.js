...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30925 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30925(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30945 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30945(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30955 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30955(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30963 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30963(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30965 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30965(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30969 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30969(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30894,callback){
var map__30897 = p__30894;
var map__30897__$1 = cljs.core.__destructure_map(map__30897);
var input = map__30897__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30897__$1,new cljs.core.Keyword(null,"code","code",1586293142));
