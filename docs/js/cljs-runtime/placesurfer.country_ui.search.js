...
var G__40663 = placesurfer.country.interface$.step_highlight_index(country_highlight_index,n,(1));
return (set_country_highlight_index_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_country_highlight_index_BANG_.cljs$core$IFn$_invoke$arity$1(G__40663) : set_country_highlight_index_BANG_.call(null,G__40663));

break;
case "ArrowUp":
e.preventDefault();

var G__40664 = placesurfer.country.interface$.step_highlight_index(country_highlight_index,n,(-1));
return (set_country_highlight_index_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_country_highlight_index_BANG_.cljs$core$IFn$_invoke$arity$1(G__40664) : set_country_highlight_index_BANG_.call(null,G__40664));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.country-search","input.country-search",1269050040),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"search",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),(t.cljs$core$IFn$_invoke$arity$1 ? t.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("country","search-placeholder","country/search-placeholder",-1195805085)) : t.call(null,new cljs.core.Keyword("country","search-placeholder","country/search-placeholder",-1195805085))),new cljs.core.Keyword(null,"aria-label","aria-label",455891514),(t.cljs$core$IFn$_invoke$arity$1 ? t.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("country","search-aria","country/search-aria",1854596116)) : t.call(null,new cljs.core.Keyword("country","search-aria","country/search-aria",1854596116))),new cljs.core.Keyword("replicant","on-render","replicant/on-render",1674377901),(function (p__40671){
var map__40672 = p__40671;
var map__40672__$1 = cljs.core.__destructure_map(map__40672);
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40672__$1,new cljs.core.Keyword("replicant","node","replicant/node",1306451380));
...
var G__40675 = query;
var G__40676 = cljs.core.count(visible);
return (set_country_filter_BANG_.cljs$core$IFn$_invoke$arity$2 ? set_country_filter_BANG_.cljs$core$IFn$_invoke$arity$2(G__40675,G__40676) : set_country_filter_BANG_.call(null,G__40675,G__40676));
