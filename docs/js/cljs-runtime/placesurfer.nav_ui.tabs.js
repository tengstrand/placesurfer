...
placesurfer.nav_ui.tabs.nav_home_tab = (function placesurfer$nav_ui$tabs$nav_home_tab(p__56622){
var map__56623 = p__56622;
var map__56623__$1 = cljs.core.__destructure_map(map__56623);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56623__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var app_version = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56623__$1,new cljs.core.Keyword(null,"app-version","app-version",361554836));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56623__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_pin_tab = (function placesurfer$nav_ui$tabs$nav_pin_tab(p__56624){
var map__56625 = p__56624;
var map__56625__$1 = cljs.core.__destructure_map(map__56625);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56625__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56625__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var navigate_to_pin_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56625__$1,new cljs.core.Keyword(null,"navigate-to-pin!","navigate-to-pin!",2100011720));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56625__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_update_tab = (function placesurfer$nav_ui$tabs$nav_update_tab(p__56626){
var map__56627 = p__56626;
var map__56627__$1 = cljs.core.__destructure_map(map__56627);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56627__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56627__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var navigate_to_update_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56627__$1,new cljs.core.Keyword(null,"navigate-to-update!","navigate-to-update!",-1444232757));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56627__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_about_tab = (function placesurfer$nav_ui$tabs$nav_about_tab(p__56628){
var map__56629 = p__56628;
var map__56629__$1 = cljs.core.__destructure_map(map__56629);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56629__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56629__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56629__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_settings_tab = (function placesurfer$nav_ui$tabs$nav_settings_tab(p__56630){
var map__56631 = p__56630;
var map__56631__$1 = cljs.core.__destructure_map(map__56631);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56631__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56631__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56631__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.tabs = (function placesurfer$nav_ui$tabs$tabs(p__56632){
var map__56633 = p__56632;
var map__56633__$1 = cljs.core.__destructure_map(map__56633);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56633__$1,new cljs.core.Keyword(null,"page","page",849072397));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56633__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var navigate_to_pin_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56633__$1,new cljs.core.Keyword(null,"navigate-to-pin!","navigate-to-pin!",2100011720));
var navigate_to_update_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56633__$1,new cljs.core.Keyword(null,"navigate-to-update!","navigate-to-update!",-1444232757));
var country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56633__$1,new cljs.core.Keyword(null,"country-code","country-code",-927451124));
var topic_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56633__$1,new cljs.core.Keyword(null,"topic-rows","topic-rows",1351926944));
var app_version = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56633__$1,new cljs.core.Keyword(null,"app-version","app-version",361554836));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56633__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
return new cljs.core.PersistentVector(null, 16, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"sl-tab-group.nav-tab-group","sl-tab-group.nav-tab-group",-27913728),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("replicant","on-mount","replicant/on-mount",-1518504162),(function (p__56634){
var map__56635 = p__56634;
var map__56635__$1 = cljs.core.__destructure_map(map__56635);
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56635__$1,new cljs.core.Keyword("replicant","node","replicant/node",1306451380));
return placesurfer.nav_ui.sync.sync_tab_group_on_page_BANG_(node,page);
}),new cljs.core.Keyword("replicant","on-render","replicant/on-render",1674377901),(function (p__56636){
var map__56637 = p__56636;
var map__56637__$1 = cljs.core.__destructure_map(map__56637);
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56637__$1,new cljs.core.Keyword("replicant","node","replicant/node",1306451380));
return placesurfer.nav_ui.sync.sync_tab_group_on_page_BANG_(node,page);
...
var G__56638 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(name);
return (navigate_BANG_.cljs$core$IFn$_invoke$arity$1 ? navigate_BANG_.cljs$core$IFn$_invoke$arity$1(G__56638) : navigate_BANG_.call(null,G__56638));
