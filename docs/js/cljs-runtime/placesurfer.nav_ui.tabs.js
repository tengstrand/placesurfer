...
placesurfer.nav_ui.tabs.nav_home_tab = (function placesurfer$nav_ui$tabs$nav_home_tab(p__41085){
var map__41086 = p__41085;
var map__41086__$1 = cljs.core.__destructure_map(map__41086);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41086__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var app_version = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41086__$1,new cljs.core.Keyword(null,"app-version","app-version",361554836));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41086__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_pin_tab = (function placesurfer$nav_ui$tabs$nav_pin_tab(p__41087){
var map__41088 = p__41087;
var map__41088__$1 = cljs.core.__destructure_map(map__41088);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41088__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41088__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var navigate_to_pin_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41088__$1,new cljs.core.Keyword(null,"navigate-to-pin!","navigate-to-pin!",2100011720));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41088__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_update_tab = (function placesurfer$nav_ui$tabs$nav_update_tab(p__41099){
var map__41100 = p__41099;
var map__41100__$1 = cljs.core.__destructure_map(map__41100);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41100__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41100__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var navigate_to_update_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41100__$1,new cljs.core.Keyword(null,"navigate-to-update!","navigate-to-update!",-1444232757));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41100__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_groups_tab = (function placesurfer$nav_ui$tabs$nav_groups_tab(p__41103){
var map__41104 = p__41103;
var map__41104__$1 = cljs.core.__destructure_map(map__41104);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41104__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41104__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41104__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_about_tab = (function placesurfer$nav_ui$tabs$nav_about_tab(p__41106){
var map__41107 = p__41106;
var map__41107__$1 = cljs.core.__destructure_map(map__41107);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41107__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41107__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41107__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_settings_tab = (function placesurfer$nav_ui$tabs$nav_settings_tab(p__41108){
var map__41109 = p__41108;
var map__41109__$1 = cljs.core.__destructure_map(map__41109);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41109__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41109__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41109__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.tabs = (function placesurfer$nav_ui$tabs$tabs(p__41110){
var map__41111 = p__41110;
var map__41111__$1 = cljs.core.__destructure_map(map__41111);
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41111__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
var topic_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41111__$1,new cljs.core.Keyword(null,"topic-rows","topic-rows",1351926944));
var backend_online_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41111__$1,new cljs.core.Keyword(null,"backend-online?","backend-online?",-200708729));
var navigate_to_pin_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41111__$1,new cljs.core.Keyword(null,"navigate-to-pin!","navigate-to-pin!",2100011720));
var navigate_to_update_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41111__$1,new cljs.core.Keyword(null,"navigate-to-update!","navigate-to-update!",-1444232757));
var country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41111__$1,new cljs.core.Keyword(null,"country-code","country-code",-927451124));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41111__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41111__$1,new cljs.core.Keyword(null,"page","page",849072397));
var app_version = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41111__$1,new cljs.core.Keyword(null,"app-version","app-version",361554836));
return new cljs.core.PersistentVector(null, 18, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"sl-tab-group.nav-tab-group","sl-tab-group.nav-tab-group",-27913728),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("replicant","on-mount","replicant/on-mount",-1518504162),(function (p__41112){
var map__41113 = p__41112;
var map__41113__$1 = cljs.core.__destructure_map(map__41113);
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41113__$1,new cljs.core.Keyword("replicant","node","replicant/node",1306451380));
return placesurfer.nav_ui.sync.sync_tab_group_on_page_BANG_(node,page);
}),new cljs.core.Keyword("replicant","on-render","replicant/on-render",1674377901),(function (p__41114){
var map__41115 = p__41114;
var map__41115__$1 = cljs.core.__destructure_map(map__41115);
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41115__$1,new cljs.core.Keyword("replicant","node","replicant/node",1306451380));
return placesurfer.nav_ui.sync.sync_tab_group_on_page_BANG_(node,page);
...
var G__41116 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(name);
return (navigate_BANG_.cljs$core$IFn$_invoke$arity$1 ? navigate_BANG_.cljs$core$IFn$_invoke$arity$1(G__41116) : navigate_BANG_.call(null,G__41116));
