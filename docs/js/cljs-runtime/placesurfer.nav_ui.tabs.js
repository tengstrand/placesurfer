...
placesurfer.nav_ui.tabs.nav_home_tab = (function placesurfer$nav_ui$tabs$nav_home_tab(p__41032){
var map__41033 = p__41032;
var map__41033__$1 = cljs.core.__destructure_map(map__41033);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41033__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41033__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_pin_tab = (function placesurfer$nav_ui$tabs$nav_pin_tab(p__41037){
var map__41038 = p__41037;
var map__41038__$1 = cljs.core.__destructure_map(map__41038);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41038__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41038__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var navigate_to_pin_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41038__$1,new cljs.core.Keyword(null,"navigate-to-pin!","navigate-to-pin!",2100011720));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41038__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_update_tab = (function placesurfer$nav_ui$tabs$nav_update_tab(p__41042){
var map__41043 = p__41042;
var map__41043__$1 = cljs.core.__destructure_map(map__41043);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41043__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41043__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var navigate_to_update_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41043__$1,new cljs.core.Keyword(null,"navigate-to-update!","navigate-to-update!",-1444232757));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41043__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_groups_tab = (function placesurfer$nav_ui$tabs$nav_groups_tab(p__41048){
var map__41049 = p__41048;
var map__41049__$1 = cljs.core.__destructure_map(map__41049);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41049__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41049__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
...
placesurfer.nav_ui.tabs.nav_about_tab = (function placesurfer$nav_ui$tabs$nav_about_tab(p__41052){
var map__41053 = p__41052;
var map__41053__$1 = cljs.core.__destructure_map(map__41053);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41053__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41053__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41053__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_settings_tab = (function placesurfer$nav_ui$tabs$nav_settings_tab(p__41054){
var map__41055 = p__41054;
var map__41055__$1 = cljs.core.__destructure_map(map__41055);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41055__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41055__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41055__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.tabs = (function placesurfer$nav_ui$tabs$tabs(p__41057){
var map__41059 = p__41057;
var map__41059__$1 = cljs.core.__destructure_map(map__41059);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41059__$1,new cljs.core.Keyword(null,"page","page",849072397));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41059__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var navigate_to_pin_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41059__$1,new cljs.core.Keyword(null,"navigate-to-pin!","navigate-to-pin!",2100011720));
var navigate_to_update_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41059__$1,new cljs.core.Keyword(null,"navigate-to-update!","navigate-to-update!",-1444232757));
var backend_online_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41059__$1,new cljs.core.Keyword(null,"backend-online?","backend-online?",-200708729));
var country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41059__$1,new cljs.core.Keyword(null,"country-code","country-code",-927451124));
var topic_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41059__$1,new cljs.core.Keyword(null,"topic-rows","topic-rows",1351926944));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41059__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
return new cljs.core.PersistentVector(null, 18, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"sl-tab-group.nav-tab-group","sl-tab-group.nav-tab-group",-27913728),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("replicant","on-mount","replicant/on-mount",-1518504162),(function (p__41063){
var map__41064 = p__41063;
var map__41064__$1 = cljs.core.__destructure_map(map__41064);
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41064__$1,new cljs.core.Keyword("replicant","node","replicant/node",1306451380));
return placesurfer.nav_ui.sync.sync_tab_group_on_page_BANG_(node,page);
}),new cljs.core.Keyword("replicant","on-render","replicant/on-render",1674377901),(function (p__41065){
...
var G__41067 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(name);
return (navigate_BANG_.cljs$core$IFn$_invoke$arity$1 ? navigate_BANG_.cljs$core$IFn$_invoke$arity$1(G__41067) : navigate_BANG_.call(null,G__41067));
