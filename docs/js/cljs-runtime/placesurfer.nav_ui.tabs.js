...
placesurfer.nav_ui.tabs.nav_home_tab = (function placesurfer$nav_ui$tabs$nav_home_tab(p__44057){
var map__44058 = p__44057;
var map__44058__$1 = cljs.core.__destructure_map(map__44058);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44058__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var app_version = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44058__$1,new cljs.core.Keyword(null,"app-version","app-version",361554836));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44058__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_pin_tab = (function placesurfer$nav_ui$tabs$nav_pin_tab(p__44059){
var map__44060 = p__44059;
var map__44060__$1 = cljs.core.__destructure_map(map__44060);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44060__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44060__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var navigate_to_pin_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44060__$1,new cljs.core.Keyword(null,"navigate-to-pin!","navigate-to-pin!",2100011720));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44060__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_update_tab = (function placesurfer$nav_ui$tabs$nav_update_tab(p__44061){
var map__44062 = p__44061;
var map__44062__$1 = cljs.core.__destructure_map(map__44062);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44062__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44062__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var navigate_to_update_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44062__$1,new cljs.core.Keyword(null,"navigate-to-update!","navigate-to-update!",-1444232757));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44062__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_groups_tab = (function placesurfer$nav_ui$tabs$nav_groups_tab(p__44063){
var map__44064 = p__44063;
var map__44064__$1 = cljs.core.__destructure_map(map__44064);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44064__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44064__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44064__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_about_tab = (function placesurfer$nav_ui$tabs$nav_about_tab(p__44065){
var map__44066 = p__44065;
var map__44066__$1 = cljs.core.__destructure_map(map__44066);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44066__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44066__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44066__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.nav_settings_tab = (function placesurfer$nav_ui$tabs$nav_settings_tab(p__44067){
var map__44068 = p__44067;
var map__44068__$1 = cljs.core.__destructure_map(map__44068);
var active_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44068__$1,new cljs.core.Keyword(null,"active-page","active-page",370357330));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44068__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44068__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
placesurfer.nav_ui.tabs.tabs = (function placesurfer$nav_ui$tabs$tabs(p__44069){
var map__44070 = p__44069;
var map__44070__$1 = cljs.core.__destructure_map(map__44070);
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__44070__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
var topic_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44070__$1,new cljs.core.Keyword(null,"topic-rows","topic-rows",1351926944));
var backend_online_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44070__$1,new cljs.core.Keyword(null,"backend-online?","backend-online?",-200708729));
var navigate_to_pin_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44070__$1,new cljs.core.Keyword(null,"navigate-to-pin!","navigate-to-pin!",2100011720));
var navigate_to_update_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44070__$1,new cljs.core.Keyword(null,"navigate-to-update!","navigate-to-update!",-1444232757));
var country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44070__$1,new cljs.core.Keyword(null,"country-code","country-code",-927451124));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44070__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44070__$1,new cljs.core.Keyword(null,"page","page",849072397));
var app_version = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44070__$1,new cljs.core.Keyword(null,"app-version","app-version",361554836));
return new cljs.core.PersistentVector(null, 18, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"sl-tab-group.nav-tab-group","sl-tab-group.nav-tab-group",-27913728),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("replicant","on-mount","replicant/on-mount",-1518504162),(function (p__44071){
var map__44072 = p__44071;
var map__44072__$1 = cljs.core.__destructure_map(map__44072);
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44072__$1,new cljs.core.Keyword("replicant","node","replicant/node",1306451380));
return placesurfer.nav_ui.sync.sync_tab_group_on_page_BANG_(node,page);
}),new cljs.core.Keyword("replicant","on-render","replicant/on-render",1674377901),(function (p__44073){
var map__44074 = p__44073;
var map__44074__$1 = cljs.core.__destructure_map(map__44074);
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44074__$1,new cljs.core.Keyword("replicant","node","replicant/node",1306451380));
return placesurfer.nav_ui.sync.sync_tab_group_on_page_BANG_(node,page);
...
var G__44075 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(name);
return (navigate_BANG_.cljs$core$IFn$_invoke$arity$1 ? navigate_BANG_.cljs$core$IFn$_invoke$arity$1(G__44075) : navigate_BANG_.call(null,G__44075));
