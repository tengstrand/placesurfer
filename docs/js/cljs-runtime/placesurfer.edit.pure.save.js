...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__39197){
var vec__39199 = p__39197;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39199,(0),null);
...
var base = (function (){var base = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic((function (p1__39202_SHARP_){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,k){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(m,k);
}),p1__39202_SHARP_,placesurfer.edit.pure.save.tombstone_dissoc_keys);
...
var name = (function (){var G__39204 = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(base);
var G__39204__$1 = (((G__39204 == null))?null:cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__39204));
if((G__39204__$1 == null)){
return null;
} else {
return clojure.string.trim(G__39204__$1);
}
})();
...
})())?cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(base__$2,new cljs.core.Keyword(null,"action","action",-811238024)):(cljs.core.truth_((function (){var G__39208 = new cljs.core.Keyword(null,"action","action",-811238024).cljs$core$IFn$_invoke$arity$1(base__$2);
var fexpr__39207 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"deleted","deleted",-510100639),null,new cljs.core.Keyword(null,"delete","delete",-1768633620),null], null), null);
return (fexpr__39207.cljs$core$IFn$_invoke$arity$1 ? fexpr__39207.cljs$core$IFn$_invoke$arity$1(G__39208) : fexpr__39207.call(null,G__39208));
...
var map__39211 = position;
var map__39211__$1 = cljs.core.__destructure_map(map__39211);
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var locality = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"locality","locality",842809377));
var homepage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"homepage","homepage",-1646828249));
var layout_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"layout-name","layout-name",-861676759));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var country_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"country-code","country-code",-927451124));
var source = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"source","source",-433931539));
var holes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"holes","holes",188002959));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39211__$1,new cljs.core.Keyword(null,"action","action",-811238024));
...
if(cljs.core.truth_((function (){var fexpr__39213 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"deleted","deleted",-510100639),null,new cljs.core.Keyword(null,"delete","delete",-1768633620),null], null), null);
return (fexpr__39213.cljs$core$IFn$_invoke$arity$1 ? fexpr__39213.cljs$core$IFn$_invoke$arity$1(kw) : fexpr__39213.call(null,kw));
})())){
...
var G__39214 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),trimmed_name,new cljs.core.Keyword(null,"longitude","longitude",-1268876372),longitude,new cljs.core.Keyword(null,"latitude","latitude",394867543),latitude,new cljs.core.Keyword(null,"country-code","country-code",-927451124),(function (){var G__39215 = country_code;
var G__39215__$1 = (((G__39215 == null))?null:clojure.string.trim(G__39215));
if((G__39215__$1 == null)){
return null;
} else {
return clojure.string.upper_case(G__39215__$1);
}
})(),new cljs.core.Keyword(null,"description","description",-1428560544),description_STAR_], null);
var G__39214__$1 = ((cljs.core.seq(clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(locality))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39214,new cljs.core.Keyword(null,"locality","locality",842809377),clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(locality))):G__39214);
var G__39214__$2 = ((cljs.core.seq(clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(homepage))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39214__$1,new cljs.core.Keyword(null,"homepage","homepage",-1646828249),clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(homepage))):G__39214__$1);
var G__39214__$3 = (cljs.core.truth_(src)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39214__$2,new cljs.core.Keyword(null,"source","source",-433931539),src):G__39214__$2);
var G__39214__$4 = (cljs.core.truth_(action_kw)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39214__$3,new cljs.core.Keyword(null,"action","action",-811238024),action_kw):G__39214__$3);
var G__39214__$5 = (((!((holes == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39214__$4,new cljs.core.Keyword(null,"holes","holes",188002959),holes):G__39214__$4);
if(cljs.core.seq(clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(layout_name)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39214__$5,new cljs.core.Keyword(null,"layout-name","layout-name",-861676759),clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(layout_name)));
} else {
return G__39214__$5;
}
} else {
