...
var fallback_discgolf = cljs.core.some((function (p1__40527_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"discgolf","discgolf",416907656),new cljs.core.Keyword(null,"topic","topic",-1960480691).cljs$core$IFn$_invoke$arity$1(p1__40527_SHARP_))){
return p1__40527_SHARP_;
} else {
return null;
}
}),topic_rows);
