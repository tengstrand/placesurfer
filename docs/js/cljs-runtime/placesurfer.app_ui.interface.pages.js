goog.provide('placesurfer.app_ui.interface$.pages');
placesurfer.app_ui.interface$.pages.map_page_QMARK_ = (function placesurfer$app_ui$interface$pages$map_page_QMARK_(page){
return placesurfer.app_ui.ui.pages.map_page_QMARK_(page);
});
placesurfer.app_ui.interface$.pages.about_page_QMARK_ = (function placesurfer$app_ui$interface$pages$about_page_QMARK_(page){
return placesurfer.app_ui.ui.pages.about_page_QMARK_(page);
});
placesurfer.app_ui.interface$.pages.topic_page_QMARK_ = (function placesurfer$app_ui$interface$pages$topic_page_QMARK_(page){
return placesurfer.app_ui.ui.pages.topic_page_QMARK_(page);
});
placesurfer.app_ui.interface$.pages.country_page_QMARK_ = (function placesurfer$app_ui$interface$pages$country_page_QMARK_(page){
return placesurfer.app_ui.ui.pages.country_page_QMARK_(page);
});
...
//# sourceMappingURL=placesurfer.app_ui.interface.pages.js.map
