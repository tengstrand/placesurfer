...
placesurfer.settings_ui.pure.panel.language_row = (function placesurfer$settings_ui$pure$panel$language_row(p__41034){
var map__41035 = p__41034;
var map__41035__$1 = cljs.core.__destructure_map(map__41035);
var locale = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41035__$1,new cljs.core.Keyword(null,"locale","locale",-2115712697));
var iso = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41035__$1,new cljs.core.Keyword(null,"iso","iso",-1366207543));
var label_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41035__$1,new cljs.core.Keyword(null,"label-key","label-key",1868394642));
var active_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41035__$1,new cljs.core.Keyword(null,"active?","active?",459499776));
var set_locale_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41035__$1,new cljs.core.Keyword(null,"set-locale!","set-locale!",136598172));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41035__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3((function (p1__41036_SHARP_){
var G__41039 = new cljs.core.Keyword(null,"label-key","label-key",1868394642).cljs$core$IFn$_invoke$arity$1(p1__41036_SHARP_);
return (t.cljs$core$IFn$_invoke$arity$1 ? t.cljs$core$IFn$_invoke$arity$1(G__41039) : t.call(null,G__41039));
}),cljs.core.compare,placesurfer.settings_ui.pure.panel.locales);
});
placesurfer.settings_ui.pure.panel.panel = (function placesurfer$settings_ui$pure$panel$panel(p__41040){
var map__41041 = p__41040;
var map__41041__$1 = cljs.core.__destructure_map(map__41041);
var locale = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41041__$1,new cljs.core.Keyword(null,"locale","locale",-2115712697),new cljs.core.Keyword(null,"en","en",88457073));
var set_locale_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41041__$1,new cljs.core.Keyword(null,"set-locale!","set-locale!",136598172),(function (_){
return null;
}));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41041__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.settings-sections","div.settings-sections",-69580065),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.settings-section","div.settings-section",-990734776),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2.settings-heading","h2.settings-heading",-1931125326),(t.cljs$core$IFn$_invoke$arity$1 ? t.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("settings","language","settings/language",1923544055)) : t.call(null,new cljs.core.Keyword("settings","language","settings/language",1923544055)))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.settings-language-list","div.settings-language-list",2081096249),(function (){var iter__5503__auto__ = (function placesurfer$settings_ui$pure$panel$panel_$_iter__41044(s__41045){
return (new cljs.core.LazySeq(null,(function (){
var s__41045__$1 = s__41045;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__41045__$1);
if(temp__5825__auto__){
var s__41045__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41045__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__41045__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__41047 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__41046 = (0);
while(true){
if((i__41046 < size__5502__auto__)){
var map__41050 = cljs.core._nth(c__5501__auto__,i__41046);
var map__41050__$1 = cljs.core.__destructure_map(map__41050);
var spec = map__41050__$1;
var locale_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41050__$1,new cljs.core.Keyword(null,"locale","locale",-2115712697));
cljs.core.chunk_append(b__41047,placesurfer.settings_ui.pure.panel.language_row(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(spec,new cljs.core.Keyword(null,"locale","locale",-2115712697),locale_code,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"active?","active?",459499776),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(locale_code,locale),new cljs.core.Keyword(null,"set-locale!","set-locale!",136598172),set_locale_BANG_,new cljs.core.Keyword(null,"t","t",-1397832519),t], 0))));

var G__41056 = (i__41046 + (1));
i__41046 = G__41056;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41047),placesurfer$settings_ui$pure$panel$panel_$_iter__41044(cljs.core.chunk_rest(s__41045__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41047),null);
}
} else {
var map__41051 = cljs.core.first(s__41045__$2);
var map__41051__$1 = cljs.core.__destructure_map(map__41051);
var spec = map__41051__$1;
var locale_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41051__$1,new cljs.core.Keyword(null,"locale","locale",-2115712697));
return cljs.core.cons(placesurfer.settings_ui.pure.panel.language_row(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(spec,new cljs.core.Keyword(null,"locale","locale",-2115712697),locale_code,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"active?","active?",459499776),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(locale_code,locale),new cljs.core.Keyword(null,"set-locale!","set-locale!",136598172),set_locale_BANG_,new cljs.core.Keyword(null,"t","t",-1397832519),t], 0))),placesurfer$settings_ui$pure$panel$panel_$_iter__41044(cljs.core.rest(s__41045__$2)));
}
} else {
return null;
}
