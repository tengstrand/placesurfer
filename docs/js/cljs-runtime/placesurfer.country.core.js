...
}catch (e39330){var _ = e39330;
return "SE";
}});
placesurfer.country.core.slug_for_iso = (function placesurfer$country$core$slug_for_iso(iso,countries){
return cljs.core.some((function (p1__39332_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(iso,new cljs.core.Keyword(null,"iso","iso",-1366207543).cljs$core$IFn$_invoke$arity$1(p1__39332_SHARP_))){
return new cljs.core.Keyword(null,"slug","slug",2029314850).cljs$core$IFn$_invoke$arity$1(p1__39332_SHARP_);
} else {
return null;
}
}),countries);
...
return cljs.core.some((function (p1__39335_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(slug,new cljs.core.Keyword(null,"slug","slug",2029314850).cljs$core$IFn$_invoke$arity$1(p1__39335_SHARP_))){
return new cljs.core.Keyword(null,"iso","iso",-1366207543).cljs$core$IFn$_invoke$arity$1(p1__39335_SHARP_);
} else {
return null;
}
}),countries);
...
return new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$1(cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__39336_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(slug,new cljs.core.Keyword(null,"slug","slug",2029314850).cljs$core$IFn$_invoke$arity$1(p1__39336_SHARP_));
}),countries)));
});
/**
...
var temp__5825__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__39338_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(slug,new cljs.core.Keyword(null,"slug","slug",2029314850).cljs$core$IFn$_invoke$arity$1(p1__39338_SHARP_));
}),countries));
if(cljs.core.truth_(temp__5825__auto__)){
var map__39339 = temp__5825__auto__;
var map__39339__$1 = cljs.core.__destructure_map(map__39339);
var west = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39339__$1,new cljs.core.Keyword(null,"west","west",708776677));
var east = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39339__$1,new cljs.core.Keyword(null,"east","east",1189821678));
var south = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39339__$1,new cljs.core.Keyword(null,"south","south",1586796293));
var north = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39339__$1,new cljs.core.Keyword(null,"north","north",651323902));
 ...
 */
placesurfer.country.core.bounds_for_pick = (function placesurfer$country$core$bounds_for_pick(p__39343){
var map__39344 = p__39343;
var map__39344__$1 = cljs.core.__destructure_map(map__39344);
var pick_west = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39344__$1,new cljs.core.Keyword(null,"pick-west","pick-west",122255929));
var pick_east = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39344__$1,new cljs.core.Keyword(null,"pick-east","pick-east",2019488979));
var pick_south = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39344__$1,new cljs.core.Keyword(null,"pick-south","pick-south",2061199937));
var pick_north = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39344__$1,new cljs.core.Keyword(null,"pick-north","pick-north",-345667041));
var west = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39344__$1,new cljs.core.Keyword(null,"west","west",708776677));
var east = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39344__$1,new cljs.core.Keyword(null,"east","east",1189821678));
var south = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39344__$1,new cljs.core.Keyword(null,"south","south",1586796293));
var north = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39344__$1,new cljs.core.Keyword(null,"north","north",651323902));
...
var map__39346 = placesurfer.country.core.bounds_for_pick(country);
var map__39346__$1 = cljs.core.__destructure_map(map__39346);
var west = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39346__$1,new cljs.core.Keyword(null,"west","west",708776677));
var east = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39346__$1,new cljs.core.Keyword(null,"east","east",1189821678));
var south = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39346__$1,new cljs.core.Keyword(null,"south","south",1586796293));
var north = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39346__$1,new cljs.core.Keyword(null,"north","north",651323902));
...
var map__39350 = placesurfer.country.core.bounds_for_pick(country);
var map__39350__$1 = cljs.core.__destructure_map(map__39350);
var west = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39350__$1,new cljs.core.Keyword(null,"west","west",708776677));
var east = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39350__$1,new cljs.core.Keyword(null,"east","east",1189821678));
var south = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39350__$1,new cljs.core.Keyword(null,"south","south",1586796293));
var north = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39350__$1,new cljs.core.Keyword(null,"north","north",651323902));
...
var G__39352 = countries;
var G__39352__$1 = (((G__39352 == null))?null:cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__39351_SHARP_){
return placesurfer.country.core.point_in_bounds_QMARK_(p1__39351_SHARP_,lon,lat);
}),G__39352));
var G__39352__$2 = (((G__39352__$1 == null))?null:cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(placesurfer.country.core.bounds_area,G__39352__$1));
var G__39352__$3 = (((G__39352__$2 == null))?null:cljs.core.first(G__39352__$2));
if((G__39352__$3 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"slug","slug",2029314850).cljs$core$IFn$_invoke$arity$1(G__39352__$3);
}
});
 ...
 */
placesurfer.country.core.select_country_plan = (function placesurfer$country$core$select_country_plan(p__39355,slug){
