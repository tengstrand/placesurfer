...
return new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),clojure.string.trim(place_name),new cljs.core.Keyword(null,"longitude","longitude",-1268876372),lon,new cljs.core.Keyword(null,"latitude","latitude",394867543),lat,new cljs.core.Keyword(null,"countrycode","countrycode",-1191088449),(function (){var G__40279 = props.countrycode;
if((G__40279 == null)){
return null;
} else {
return clojure.string.upper_case(G__40279);
}
...
var len__5749__auto___40295 = arguments.length;
var i__5750__auto___40296 = (0);
while(true){
if((i__5750__auto___40296 < len__5749__auto___40295)){
args__5755__auto__.push((arguments[i__5750__auto___40296]));

var G__40297 = (i__5750__auto___40296 + (1));
i__5750__auto___40296 = G__40297;
continue;
} else {
}
break;
...
(placesurfer.pin_ui.pure.photon.build_search_url.cljs$core$IFn$_invoke$arity$variadic = (function (query,limit,p__40284){
var map__40285 = p__40284;
var map__40285__$1 = cljs.core.__destructure_map(map__40285);
var countries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40285__$1,new cljs.core.Keyword(null,"countries","countries",863192750));
var country_slug = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40285__$1,new cljs.core.Keyword(null,"country-slug","country-slug",769681844));
...
var map__40286 = bounds;
var map__40286__$1 = cljs.core.__destructure_map(map__40286);
var west = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40286__$1,new cljs.core.Keyword(null,"west","west",708776677));
var east = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40286__$1,new cljs.core.Keyword(null,"east","east",1189821678));
var south = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40286__$1,new cljs.core.Keyword(null,"south","south",1586796293));
var north = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40286__$1,new cljs.core.Keyword(null,"north","north",651323902));
...
/** @this {Function} */
(placesurfer.pin_ui.pure.photon.build_search_url.cljs$lang$applyTo = (function (seq40280){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40281,G__40282,seq40280__$2);
}));
...
var map__40287 = bounds;
var map__40287__$1 = cljs.core.__destructure_map(map__40287);
var west = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40287__$1,new cljs.core.Keyword(null,"west","west",708776677));
var east = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40287__$1,new cljs.core.Keyword(null,"east","east",1189821678));
var south = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40287__$1,new cljs.core.Keyword(null,"south","south",1586796293));
var north = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40287__$1,new cljs.core.Keyword(null,"north","north",651323902));
 ...
 */
placesurfer.pin_ui.pure.photon.result_in_search_country_QMARK_ = (function placesurfer$pin_ui$pure$photon$result_in_search_country_QMARK_(p__40289,country_iso,countries,country_slug){
var map__40290 = p__40289;
var map__40290__$1 = cljs.core.__destructure_map(map__40290);
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40290__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40290__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var countrycode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40290__$1,new cljs.core.Keyword(null,"countrycode","countrycode",-1191088449));
...
placesurfer.pin_ui.pure.photon.result_in_current_country_QMARK_ = (function placesurfer$pin_ui$pure$photon$result_in_current_country_QMARK_(p__40291,country_iso,countries,country_slug){
var map__40292 = p__40291;
var map__40292__$1 = cljs.core.__destructure_map(map__40292);
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40292__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40292__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var countrycode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40292__$1,new cljs.core.Keyword(null,"countrycode","countrycode",-1191088449));
...
return cljs.core.vec(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40293_SHARP_){
return placesurfer.pin_ui.pure.photon.result_in_search_country_QMARK_(p1__40293_SHARP_,country_iso,countries,country_slug);
}),results));
} else {
