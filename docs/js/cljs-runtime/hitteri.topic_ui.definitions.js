goog.provide('hitteri.topic_ui.definitions');
/**
 * One {:topic :label :marker-url} map per topic key, in key order.
 */
hitteri.topic_ui.definitions.from_keys = (function hitteri$topic_ui$definitions$from_keys(topic_keys,label_fn,marker_url_fn){
...
//# sourceMappingURL=hitteri.topic_ui.definitions.js.map
