...
placesurfer.map_panel_ui.home_search.home_search = (function placesurfer$map_panel_ui$home_search$home_search(p__40722){
var map__40723 = p__40722;
var map__40723__$1 = cljs.core.__destructure_map(map__40723);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var results = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"results","results",-1134170113));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
var highlight_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"highlight-index","highlight-index",172822010));
var set_query_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"set-query!","set-query!",1034991167));
var select_result_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"select-result!","select-result!",-1027304474));
var keydown_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"keydown!","keydown!",-2130509954));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40723__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
...
var G__40724 = e.target.value;
return (set_query_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_query_BANG_.cljs$core$IFn$_invoke$arity$1(G__40724) : set_query_BANG_.call(null,G__40724));
