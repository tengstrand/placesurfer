goog.provide('placesurfer.pin_ui.pure.toolbar_search');
placesurfer.pin_ui.pure.toolbar_search.coerce_text = (function placesurfer$pin_ui$pure$toolbar_search$coerce_text(v){
if(typeof v === 'string'){
return v;
} else {
if((v == null)){
...
placesurfer.pin_ui.pure.toolbar_search.search_field = (function placesurfer$pin_ui$pure$toolbar_search$search_field(p__41357){
var map__41358 = p__41357;
var map__41358__$1 = cljs.core.__destructure_map(map__41358);
var input_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41358__$1,new cljs.core.Keyword(null,"input-id","input-id",1217549113));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41358__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
var highlight_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41358__$1,new cljs.core.Keyword(null,"highlight-index","highlight-index",172822010));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41358__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var keydown_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41358__$1,new cljs.core.Keyword(null,"keydown!","keydown!",-2130509954));
var set_query_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41358__$1,new cljs.core.Keyword(null,"set-query!","set-query!",1034991167));
var results = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41358__$1,new cljs.core.Keyword(null,"results","results",-1134170113));
var select_result_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41358__$1,new cljs.core.Keyword(null,"select-result!","select-result!",-1027304474));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41358__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
var toolbar_search_end_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41358__$1,new cljs.core.Keyword(null,"toolbar-search-end?","toolbar-search-end?",932086865));
var results_list_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41358__$1,new cljs.core.Keyword(null,"results-list-id","results-list-id",1934165974));
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.update-toolbar-search","div.update-toolbar-search",-1994646634),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(toolbar_search_end_QMARK_)?"update-toolbar-search--end":null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img.update-toolbar-search-icon","img.update-toolbar-search-icon",-558242337),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),"/images/search.png",new cljs.core.Keyword(null,"alt","alt",-3214426),""], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.update-toolbar-search-input","input.update-toolbar-search-input",-1844597392),(function (){var G__41361 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"aria-label","aria-label",455891514),(t.cljs$core$IFn$_invoke$arity$1 ? t.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("pin","search-place","pin/search-place",-229499657)) : t.call(null,new cljs.core.Keyword("pin","search-place","pin/search-place",-229499657))),new cljs.core.Keyword(null,"aria-autocomplete","aria-autocomplete",860626940),"list",new cljs.core.Keyword(null,"aria-expanded","aria-expanded",-1360942393),cljs.core.boolean$(cljs.core.seq(results)),new cljs.core.Keyword(null,"value","value",305978217),placesurfer.pin_ui.pure.toolbar_search.coerce_text(query),new cljs.core.Keyword(null,"on","on",173873944),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"input","input",556931961),(function (e){
var G__41362 = e.target.value;
return (set_query_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_query_BANG_.cljs$core$IFn$_invoke$arity$1(G__41362) : set_query_BANG_.call(null,G__41362));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41361,new cljs.core.Keyword(null,"id","id",-1388402092),input_id);
} else {
return G__41361;
}
})()], null),(cljs.core.truth_(loading_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.update-toolbar-search-loading","p.update-toolbar-search-loading",895486651),(t.cljs$core$IFn$_invoke$arity$1 ? t.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("pin","searching","pin/searching",1101247042)) : t.call(null,new cljs.core.Keyword("pin","searching","pin/searching",1101247042)))], null):null),((cljs.core.seq(results))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.update-toolbar-search-results","ul.update-toolbar-search-results",-33148561),(function (){var G__41364 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"role","role",-736691072),"listbox"], null);
if(cljs.core.truth_(results_list_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41364,new cljs.core.Keyword(null,"id","id",-1388402092),results_list_id);
} else {
return G__41364;
}
})(),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (idx,p__41365){
var map__41366 = p__41365;
var map__41366__$1 = cljs.core.__destructure_map(map__41366);
var result = map__41366__$1;
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41366__$1,new cljs.core.Keyword(null,"label","label",1718410804));
