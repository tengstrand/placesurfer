...
placesurfer.pin_ui.pure.toolbar_search.search_field = (function placesurfer$pin_ui$pure$toolbar_search$search_field(p__41222){
var map__41223 = p__41222;
var map__41223__$1 = cljs.core.__destructure_map(map__41223);
var input_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41223__$1,new cljs.core.Keyword(null,"input-id","input-id",1217549113));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41223__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
var highlight_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41223__$1,new cljs.core.Keyword(null,"highlight-index","highlight-index",172822010));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41223__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var keydown_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41223__$1,new cljs.core.Keyword(null,"keydown!","keydown!",-2130509954));
var set_query_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41223__$1,new cljs.core.Keyword(null,"set-query!","set-query!",1034991167));
var results = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41223__$1,new cljs.core.Keyword(null,"results","results",-1134170113));
var select_result_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41223__$1,new cljs.core.Keyword(null,"select-result!","select-result!",-1027304474));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41223__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
var toolbar_search_end_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41223__$1,new cljs.core.Keyword(null,"toolbar-search-end?","toolbar-search-end?",932086865));
var results_list_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41223__$1,new cljs.core.Keyword(null,"results-list-id","results-list-id",1934165974));
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.update-toolbar-search","div.update-toolbar-search",-1994646634),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(toolbar_search_end_QMARK_)?"update-toolbar-search--end":null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img.update-toolbar-search-icon","img.update-toolbar-search-icon",-558242337),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"src","src",-1651076051),"/images/search.png",new cljs.core.Keyword(null,"alt","alt",-3214426),""], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.update-toolbar-search-input","input.update-toolbar-search-input",-1844597392),(function (){var G__41226 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"aria-label","aria-label",455891514),(t.cljs$core$IFn$_invoke$arity$1 ? t.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("pin","search-place","pin/search-place",-229499657)) : t.call(null,new cljs.core.Keyword("pin","search-place","pin/search-place",-229499657))),new cljs.core.Keyword(null,"aria-autocomplete","aria-autocomplete",860626940),"list",new cljs.core.Keyword(null,"aria-expanded","aria-expanded",-1360942393),cljs.core.boolean$(cljs.core.seq(results)),new cljs.core.Keyword(null,"value","value",305978217),placesurfer.pin_ui.pure.toolbar_search.coerce_text(query),new cljs.core.Keyword(null,"on","on",173873944),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"input","input",556931961),(function (e){
var G__41227 = e.target.value;
return (set_query_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_query_BANG_.cljs$core$IFn$_invoke$arity$1(G__41227) : set_query_BANG_.call(null,G__41227));
