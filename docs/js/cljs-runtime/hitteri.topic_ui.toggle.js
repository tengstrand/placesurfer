goog.provide('hitteri.topic_ui.toggle');
hitteri.topic_ui.toggle.toggle_active = (function hitteri$topic_ui$toggle$toggle_active(active_topics,topic){
 ...
 */
hitteri.topic_ui.toggle.toggle_plan = (function hitteri$topic_ui$toggle$toggle_plan(active_topics,topic){
var next_topics = hitteri.topic_ui.toggle.toggle_active(active_topics,topic);
...
//# sourceMappingURL=hitteri.topic_ui.toggle.js.map
