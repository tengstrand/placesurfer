...
}catch (e40955){var _ = e40955;
return false;
}});
placesurfer.web_app.nav.focus_country_search_BANG_ = (function placesurfer$web_app$nav$focus_country_search_BANG_(){
var seq__40959 = cljs.core.seq(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(60),(140),(260)], null));
var chunk__40960 = null;
var count__40961 = (0);
var i__40962 = (0);
while(true){
if((i__40962 < count__40961)){
var delay_ms = chunk__40960.cljs$core$IIndexed$_nth$arity$2(null,i__40962);
setTimeout(((function (seq__40959,chunk__40960,count__40961,i__40962,delay_ms){
return (function (){
...
});})(seq__40959,chunk__40960,count__40961,i__40962,delay_ms))
,delay_ms);


var G__40993 = seq__40959;
var G__40994 = chunk__40960;
var G__40995 = count__40961;
var G__40996 = (i__40962 + (1));
seq__40959 = G__40993;
chunk__40960 = G__40994;
count__40961 = G__40995;
i__40962 = G__40996;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__40959);
if(temp__5825__auto__){
var seq__40959__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__40959__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__40959__$1);
var G__40998 = cljs.core.chunk_rest(seq__40959__$1);
var G__40999 = c__5548__auto__;
var G__41000 = cljs.core.count(c__5548__auto__);
var G__41001 = (0);
seq__40959 = G__40998;
chunk__40960 = G__40999;
count__40961 = G__41000;
i__40962 = G__41001;
continue;
} else {
var delay_ms = cljs.core.first(seq__40959__$1);
setTimeout(((function (seq__40959,chunk__40960,count__40961,i__40962,delay_ms,seq__40959__$1,temp__5825__auto__){
return (function (){
...
});})(seq__40959,chunk__40960,count__40961,i__40962,delay_ms,seq__40959__$1,temp__5825__auto__))
,delay_ms);


var G__41002 = cljs.core.next(seq__40959__$1);
var G__41003 = null;
var G__41004 = (0);
var G__41005 = (0);
seq__40959 = G__41002;
chunk__40960 = G__41003;
count__40961 = G__41004;
i__40962 = G__41005;
continue;
}
} else {
...
var map__40975 = placesurfer.country.interface$.navigate_country_plan(target_page);
var map__40975__$1 = cljs.core.__destructure_map(map__40975);
var focus_search_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40975__$1,new cljs.core.Keyword(null,"focus-search?","focus-search?",-1381981880));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(placesurfer.web_app.state._BANG_state,(function (s){
var G__40976 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(s,new cljs.core.Keyword(null,"update-country-code","update-country-code",1545858722),(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"country-iso","country-iso",-1029731117).cljs$core$IFn$_invoke$arity$1(s);
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__40976,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"update-form","update-form",475718790),new cljs.core.Keyword(null,"source","source",-433931539)], null),placesurfer.edit.interface$.baseline.normalize_update_source);
} else {
return G__40976;
}
}));
...
var map__40979 = placesurfer.country.interface$.select_country_plan(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"current-slug","current-slug",-1084358059),new cljs.core.Keyword(null,"country-slug","country-slug",769681844).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.web_app.state._BANG_state)),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.web_app.state._BANG_state)),new cljs.core.Keyword(null,"mobile?","mobile?",1358664528),placesurfer.web_app.nav.small_screen_QMARK_()], null),slug);
var map__40979__$1 = cljs.core.__destructure_map(map__40979);
var same_country_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40979__$1,new cljs.core.Keyword(null,"same-country?","same-country?",2096767045));
var clear_filter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40979__$1,new cljs.core.Keyword(null,"clear-filter?","clear-filter?",-1068595548));
var switch_to_country_page_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40979__$1,new cljs.core.Keyword(null,"switch-to-country-page?","switch-to-country-page?",1468335198));
var focus_search_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40979__$1,new cljs.core.Keyword(null,"focus-search?","focus-search?",-1381981880));
var load_country_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40979__$1,new cljs.core.Keyword(null,"load-country?","load-country?",-2106770458));
var navigate_home_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40979__$1,new cljs.core.Keyword(null,"navigate-home?","navigate-home?",-828264994));
var load_options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40979__$1,new cljs.core.Keyword(null,"load-options","load-options",-38528641));
...
var map__40987_41015 = placesurfer.country.interface$.set_country_filter_plan(query);
var map__40987_41016__$1 = cljs.core.__destructure_map(map__40987_41015);
var country_filter_41017 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40987_41016__$1,new cljs.core.Keyword(null,"country-filter","country-filter",-2099038819));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(placesurfer.web_app.state._BANG_state,cljs.core.assoc,new cljs.core.Keyword(null,"country-filter","country-filter",-2099038819),country_filter_41017,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"country-highlight-index","country-highlight-index",-1271997150),(((!((visible_count == null))))?placesurfer.country.interface$.highlight_index_after_filter(visible_count):new cljs.core.Keyword(null,"country-highlight-index","country-highlight-index",-1271997150).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.web_app.state._BANG_state)))], 0));
