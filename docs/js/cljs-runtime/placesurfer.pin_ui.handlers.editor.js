...
var seq__39785 = cljs.core.seq(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(60),(140),(260)], null));
var chunk__39786 = null;
var count__39787 = (0);
var i__39788 = (0);
while(true){
if((i__39788 < count__39787)){
var delay_ms = chunk__39786.cljs$core$IIndexed$_nth$arity$2(null,i__39788);
setTimeout(((function (seq__39785,chunk__39786,count__39787,i__39788,delay_ms){
return (function (){
...
});})(seq__39785,chunk__39786,count__39787,i__39788,delay_ms))
,delay_ms);


var G__39809 = seq__39785;
var G__39810 = chunk__39786;
var G__39811 = count__39787;
var G__39812 = (i__39788 + (1));
seq__39785 = G__39809;
chunk__39786 = G__39810;
count__39787 = G__39811;
i__39788 = G__39812;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__39785);
if(temp__5825__auto__){
var seq__39785__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__39785__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__39785__$1);
var G__39813 = cljs.core.chunk_rest(seq__39785__$1);
var G__39814 = c__5548__auto__;
var G__39815 = cljs.core.count(c__5548__auto__);
var G__39816 = (0);
seq__39785 = G__39813;
chunk__39786 = G__39814;
count__39787 = G__39815;
i__39788 = G__39816;
continue;
} else {
var delay_ms = cljs.core.first(seq__39785__$1);
setTimeout(((function (seq__39785,chunk__39786,count__39787,i__39788,delay_ms,seq__39785__$1,temp__5825__auto__){
return (function (){
...
});})(seq__39785,chunk__39786,count__39787,i__39788,delay_ms,seq__39785__$1,temp__5825__auto__))
,delay_ms);


var G__39817 = cljs.core.next(seq__39785__$1);
var G__39818 = null;
var G__39819 = (0);
var G__39820 = (0);
seq__39785 = G__39817;
chunk__39786 = G__39818;
count__39787 = G__39819;
i__39788 = G__39820;
continue;
}
} else {
...
placesurfer.pin_ui.handlers.state.swap_render_BANG_((function (p1__39789_SHARP_){
return placesurfer.pin_ui.handlers.state.clear_search_ui(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__39789_SHARP_,new cljs.core.Keyword(null,"pin-editor-mode","pin-editor-mode",-577269186),null,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"pin-show-search?","pin-show-search?",-437021687),false,new cljs.core.Keyword(null,"pin-form","pin-form",1370425130),placesurfer.pin_ui.pure.forms.default_form(),new cljs.core.Keyword(null,"pin-form-baseline","pin-form-baseline",552218539),placesurfer.pin_ui.pure.forms.default_form(),new cljs.core.Keyword(null,"pin-message","pin-message",-1508485154),null], 0)));
}));
...
return placesurfer.pin_ui.handlers.rows.save_pin_BANG_();
} else {
return null;
}
} else {
...
if(cljs.core.truth_(placesurfer.pin_ui.handlers.editor.inline_edit_active_QMARK_(cljs.core.deref(placesurfer.app_ui.interface$.state._BANG_state)))){
var temp__5825__auto___39823 = cljs.core.deref(placesurfer.pin_ui.handlers.editor._BANG_inline_auto_save_timeout);
if(cljs.core.truth_(temp__5825__auto___39823)){
var timeout_39825 = temp__5825__auto___39823;
clearTimeout(timeout_39825);
} else {
}
...
var temp__5825__auto___39826 = cljs.core.deref(placesurfer.pin_ui.handlers.editor._BANG_inline_auto_save_timeout);
if(cljs.core.truth_(temp__5825__auto___39826)){
var timeout_39827 = temp__5825__auto___39826;
clearTimeout(timeout_39827);
...
var len__5749__auto___39831 = arguments.length;
var i__5750__auto___39832 = (0);
while(true){
if((i__5750__auto___39832 < len__5749__auto___39831)){
args__5755__auto__.push((arguments[i__5750__auto___39832]));

var G__39834 = (i__5750__auto___39832 + (1));
i__5750__auto___39832 = G__39834;
continue;
} else {
}
break;
...
(placesurfer.pin_ui.handlers.editor.open_editor_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (mode,form,p__39793){
var map__39794 = p__39793;
var map__39794__$1 = cljs.core.__destructure_map(map__39794);
var show_search_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__39794__$1,new cljs.core.Keyword(null,"show-search?","show-search?",684663920),false);
var focus_search_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__39794__$1,new cljs.core.Keyword(null,"focus-search?","focus-search?",-1381981880),false);
var focus_name_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__39794__$1,new cljs.core.Keyword(null,"focus-name?","focus-name?",-1683047612),true);
...
/** @this {Function} */
(placesurfer.pin_ui.handlers.editor.open_editor_BANG_.cljs$lang$applyTo = (function (seq39790){
var G__39791 = cljs.core.first(seq39790);
var seq39790__$1 = cljs.core.next(seq39790);
var G__39792 = cljs.core.first(seq39790__$1);
var seq39790__$2 = cljs.core.next(seq39790__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39791,G__39792,seq39790__$2);
}));
...
var G__39801_39855 = mode;
var G__39801_39856__$1 = (((G__39801_39855 instanceof cljs.core.Keyword))?G__39801_39855.fqn:null);
switch (G__39801_39856__$1) {
case "new":
placesurfer.pin_ui.handlers.rows.add_pin_BANG_.cljs$core$IFn$_invoke$arity$0();

break;
case "edit":
placesurfer.pin_ui.handlers.rows.save_pin_BANG_();
...
if(and__5023__auto__){
return cljs.core.some((function (p1__39803_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__39803_SHARP_));
...
var G__39805 = new cljs.core.Keyword(null,"pin-editor-mode","pin-editor-mode",-577269186).cljs$core$IFn$_invoke$arity$1(state);
