...
if(cljs.core.truth_(temp__5825__auto__)){
var vec__39129 = temp__5825__auto__;
var lat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39129,(0),null);
var lon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39129,(1),null);
...
var lat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39132,(0),null);
var lon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39132,(1),null);
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"latitude","latitude",394867543),placesurfer.googlestreetmap.core.parse_number(lat),new cljs.core.Keyword(null,"longitude","longitude",-1268876372),placesurfer.googlestreetmap.core.parse_number(lon)], null);
} else {
return null;
}
...
if(cljs.core.truth_(temp__5825__auto__)){
var vec__39141 = temp__5825__auto__;
var raw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39141,(0),null);
...
if(cljs.core.truth_(temp__5825__auto__)){
var vec__39144 = temp__5825__auto__;
var raw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39144,(0),null);
return placesurfer.googlestreetmap.core.decode(raw);
} else {
return null;
}
...
var text_STAR_ = (function (){var G__39148 = text;
if((G__39148 == null)){
return null;
} else {
return clojure.string.lower_case(G__39148);
}
})();
return cljs.core.some((function (p__39149){
var map__39151 = p__39149;
var map__39151__$1 = cljs.core.__destructure_map(map__39151);
var iso = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39151__$1,new cljs.core.Keyword(null,"iso","iso",-1366207543));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39151__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var slug = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39151__$1,new cljs.core.Keyword(null,"slug","slug",2029314850));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39151__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
var found_QMARK_ = cljs.core.some((function (p1__39147_SHARP_){
return clojure.string.includes_QMARK_(text_STAR_,clojure.string.lower_case(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__39147_SHARP_)));
}),candidates);
...
var G__39153 = cljs.core.PersistentArrayMap.EMPTY;
var G__39153__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"latitude","latitude",394867543).cljs$core$IFn$_invoke$arity$1(coords))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39153,new cljs.core.Keyword(null,"latitude","latitude",394867543),new cljs.core.Keyword(null,"latitude","latitude",394867543).cljs$core$IFn$_invoke$arity$1(coords)):G__39153);
var G__39153__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"longitude","longitude",-1268876372).cljs$core$IFn$_invoke$arity$1(coords))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39153__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372),new cljs.core.Keyword(null,"longitude","longitude",-1268876372).cljs$core$IFn$_invoke$arity$1(coords)):G__39153__$1);
var G__39153__$3 = ((cljs.core.seq(name))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39153__$2,new cljs.core.Keyword(null,"name","name",1843675177),name):G__39153__$2);
if(cljs.core.seq(country_code)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39153__$3,new cljs.core.Keyword(null,"country-code","country-code",-927451124),country_code);
} else {
return G__39153__$3;
}
} else {
 ...
 */
placesurfer.googlestreetmap.core.build_maps_location_url = (function placesurfer$googlestreetmap$core$build_maps_location_url(p__39162){
var map__39163 = p__39162;
var map__39163__$1 = cljs.core.__destructure_map(map__39163);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39163__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39163__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39163__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
 ...
 */
placesurfer.googlestreetmap.core.build_maps_search_link_html = (function placesurfer$googlestreetmap$core$build_maps_search_link_html(p__39165){
var map__39166 = p__39165;
var map__39166__$1 = cljs.core.__destructure_map(map__39166);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39166__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39166__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39166__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
var temp__5825__auto__ = cljs.core.not_empty(clojure.string.trim(cljs.core.str.cljs$core$IFn$_invoke$arity$1(query)));
if(cljs.core.truth_(temp__5825__auto__)){
 ...
 */
placesurfer.googlestreetmap.core.place_external_links = (function placesurfer$googlestreetmap$core$place_external_links(p__39182){
var map__39183 = p__39182;
var map__39183__$1 = cljs.core.__destructure_map(map__39183);
var address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39183__$1,new cljs.core.Keyword(null,"address","address",559499426));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39183__$1,new cljs.core.Keyword(null,"url","url",276297046));
var latitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39183__$1,new cljs.core.Keyword(null,"latitude","latitude",394867543));
var longitude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39183__$1,new cljs.core.Keyword(null,"longitude","longitude",-1268876372));
 ...
 */
placesurfer.googlestreetmap.core.build_external_icon_link_html = (function placesurfer$googlestreetmap$core$build_external_icon_link_html(p__39187){
...
var icon_src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39188__$1,new cljs.core.Keyword(null,"icon-src","icon-src",1550418733));
var icon_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39188__$1,new cljs.core.Keyword(null,"icon-class","icon-class",-216197803));
var link_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39188__$1,new cljs.core.Keyword(null,"link-class","link-class",609379382));
var aria_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39188__$1,new cljs.core.Keyword(null,"aria-label","aria-label",455891514));
var temp__5825__auto__ = placesurfer.googlestreetmap.core.non_blank(url);
if(cljs.core.truth_(temp__5825__auto__)){
var href = temp__5825__auto__;
return ["<a class=\"",placesurfer.googlestreetmap.core.escape_html_text(placesurfer.googlestreetmap.core.link_class_attr(link_class)),"\" href=\"",placesurfer.googlestreetmap.core.escape_html_text(href),"\" target=\"_blank\" rel=\"noopener noreferrer\"",(cljs.core.truth_(aria_label)?[" aria-label=\"",placesurfer.googlestreetmap.core.escape_html_text(aria_label),"\""].join(''):null),"><img class=\"",placesurfer.googlestreetmap.core.escape_html_text((function (){var or__5025__auto__ = icon_class;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
 ...
 */
placesurfer.googlestreetmap.core.build_maps_icon_link_html = (function placesurfer$googlestreetmap$core$build_maps_icon_link_html(p__39189){
...
if(cljs.core.truth_(temp__5825__auto__)){
var map__39191 = temp__5825__auto__;
var map__39191__$1 = cljs.core.__destructure_map(map__39191);
var google_maps_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39191__$1,new cljs.core.Keyword(null,"google-maps-url","google-maps-url",1524070940));
var hemnet_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39191__$1,new cljs.core.Keyword(null,"hemnet-url","hemnet-url",-1665312184));
