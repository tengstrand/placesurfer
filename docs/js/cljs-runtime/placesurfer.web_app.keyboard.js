...
var page = new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(placesurfer.web_app.state._BANG_state));
...
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("c",key)) && (placesurfer.app_ui.interface$.pages.map_page_QMARK_(page)))){
e.preventDefault();

return placesurfer.web_app.map_country.enable_country_pick_BANG_();
} else {
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("c",key)) && ((!(placesurfer.app_ui.interface$.pages.map_page_QMARK_(page)))))){
e.preventDefault();
