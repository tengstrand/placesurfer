...
placesurfer.pin_ui.pure.editor_pane.editor_pane = (function placesurfer$pin_ui$pure$editor_pane$editor_pane(p__41224){
var map__41225 = p__41224;
var map__41225__$1 = cljs.core.__destructure_map(map__41225);
var props = map__41225__$1;
var pin_message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41225__$1,new cljs.core.Keyword(null,"pin-message","pin-message",-1508485154));
var pin_editor_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41225__$1,new cljs.core.Keyword(null,"pin-editor-mode","pin-editor-mode",-577269186));
var pin_editor_inline_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41225__$1,new cljs.core.Keyword(null,"pin-editor-inline?","pin-editor-inline?",766617935));
var cancel_pin_editor_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41225__$1,new cljs.core.Keyword(null,"cancel-pin-editor!","cancel-pin-editor!",1051044642));
var confirm_pin_editor_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41225__$1,new cljs.core.Keyword(null,"confirm-pin-editor!","confirm-pin-editor!",-1792781208));
var pin_editor_ok_enabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41225__$1,new cljs.core.Keyword(null,"pin-editor-ok-enabled?","pin-editor-ok-enabled?",1889379090));
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41225__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
