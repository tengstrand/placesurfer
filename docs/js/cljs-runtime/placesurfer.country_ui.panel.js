...
placesurfer.country_ui.panel.panel = (function placesurfer$country_ui$panel$panel(p__41018){
var map__41019 = p__41018;
var map__41019__$1 = cljs.core.__destructure_map(map__41019);
var t = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41019__$1,new cljs.core.Keyword(null,"t","t",-1397832519),(function (k){
return cljs.core.name(k);
}));
var countries_loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"countries-loading?","countries-loading?",-1018911139));
var country_filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"country-filter","country-filter",-2099038819));
var ensure_countries_loaded_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"ensure-countries-loaded!","ensure-countries-loaded!",1392756926));
var country_highlight_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"country-highlight-index","country-highlight-index",-1271997150));
var select_country_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"select-country!","select-country!",-1237350741));
var navigate_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"navigate!","navigate!",79998348));
var countries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"countries","countries",863192750));
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var set_country_filter_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"set-country-filter!","set-country-filter!",-1983545420));
var country_slug = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"country-slug","country-slug",769681844));
var set_country_highlight_index_BANG_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41019__$1,new cljs.core.Keyword(null,"set-country-highlight-index!","set-country-highlight-index!",1161345176));
